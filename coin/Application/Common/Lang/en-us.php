...
return [
    ...
    '关于BingX'=>'About BingX',
    'BingX成立于2018年，是全球领先的加密货币交易所，为全球1,000多万名用户提供现货、衍生品、跟单和资产管理等多元化的产品和服务，满足新手到专业人士的不同层级需求。'=>'BingX was established in 2018 and is the worlds leading cryptocurrency exchange. It provides more than 10 million users around the world with diversified products and services such as spot, derivatives, documentary and asset management, catering to novices to professionals. Different levels of needs of people.',
    '致力于提供值得信赖的平台，赋予用户创新工具和功能以提升其交易能力。'=>'is committed to providing a trustworthy platform that empowers users with innovative tools and features to enhance their trading capabilities.',
    '切尔西足球俱乐部官方加密货币交易所合作伙伴'=>'Chelsea Football Club Official Cryptocurrency Exchange Partner',
    '赋能未来'=>'Empower the future',
    '赋能交易者'=>'Empower traders',
    '我们致力于构建一个以用户为先的平台，让交易更加便捷、迅速，助力交易者发挥其交易技能，在加密货币市场取得更多成就。我们的目标是启发用户，让他们始终领先一步，同时确保交易安全、高效、有效。'=>'We are committed to building a user-first platform to make transactions more convenient and faster, helping traders to develop their trading skills and achieve more achievements in the cryptocurrency market. Our goal is to inspire users and keep them one step ahead at all times, while ensuring transactions are safe, efficient and effective.',
    '品牌合规'=>'Brand Compliance',
    'BingX是一家全球化的数字金融服务机构，在亚洲、大洋洲、欧洲及南美洲等地区设有办事处。在其面向运营的国家和地区，已登记或获得受当地政府认可和监管的金融服务牌照。'=>'BingX is a global digital financial services organization with offices in Asia, Oceania, Europe and South America. In the countries and regions where it operates, it has been registered or obtained a financial services license recognized and supervised by the local government.',
    'BingX是BingX Group的注册商标，其全球子公司和分支机构拥有以下许可和注册证书：'=>'BingX is a registered trademark of BingX Group and its subsidiaries and affiliates worldwide hold the following licenses and registration certificates:',
    '欧盟'=>'EU',
    '一家注册于欧盟成员国立陶宛金融管理局，并受其认可和监管的金融服务公司，提供数字货币交易服务。'=>'A financial services company registered with, recognized and supervised by the Financial Authority of Lithuania, an EU member state, providing digital currency trading services.',
    '澳大利亚'=>'Australia',
    '是一家在澳大利亚政府AUSTRAC注册并获授权的'=>'It is a company registered and authorized by AUSTRAC, the Australian government',
    '联系合规团队'=>'Contact Compliance Team',
    '安全透明'=>'Security and Transparency',
    '保证金'=>'Margin',
    '已完成全球权威会计师事务所Mazars资产验证，并已出具PoR认证报告'=>'The asset verification of Mazars, a global authoritative accounting firm, has been completed, and a PoR certification report has been issued',
    '与顶级安全机构协作，已透过全球安全领域权威机构CertiK安全审计'=>'Collaborated with top security organizations, and passed the CertiK security audit, an authoritative organization in the global security field',
    '使命'=>'Mission',
    '为用户提供值得信赖和透明的平台，让所有人都可以便捷友好地使用加密货币。'=>'Provide users with a trustworthy and transparent platform that makes cryptocurrency use convenient and friendly for everyone.',
    '愿景'=>'Vision',
    '成为所有用户通往加密数字世界的大门'=>'Be the door to the encrypted digital world for all users',
    '价值观'=>'Values',
    '用户为先'=>'User first',
    '一切以用户为先，让用户始终快人一步，在加密货币领域取得更多成就。'=>'Everything puts users first, allowing users to always be one step ahead of others and achieve more in the field of cryptocurrency.',
    '安全可靠'=>'Safe and reliable',
    '提供安全的平台，为用户资产作100%的保证金储备并提供全球24/7支援。'=>'Provide a secure platform with 100% margin reserve for user assets and provide global 24/7 support.',
    '卓越创新'=>'Excellent innovation',
    '持续创新并推出新功能、新策略，助力用户提升交易水平。'=>'Continue to innovate and launch new features and strategies to help users improve their trading skills.',
    '多元发展'=>'Diversified development',
    '全方位的产品和服务满足不同级别的用户需求，不论您是新手还是专业人士。'=>'A full range of products and services to meet different levels of user needs, whether you are a novice or a professional.',
    '品牌荣誉'=>'Brand Honor',
    '2021与2022年度最佳加密交易所'=>'Best Crypto Exchange of 2021 and 2022',
    '年度增长最快社交交易平台'=>'The fastest growing social trading platform of the year',
    '评选值得信赖品牌'=>'Select trustworthy brands',
    '24小时客服线上服务'=>'24-hour customer service online service',
    '如您在使用BingX的过程中遇到任何问题，可随时透过'=>'If you encounter any problems while using BingX, you can always go through',
    '咨询线上客服。如需即时帮助，您可点选萤幕右侧的“线上交谈”视窗转接全天候线上人工服务。'=>'Consult online customer service. If you need immediate assistance, you can click the "Online Chat" window on the right side of the screen to transfer to 24/7 online manual services.',
    '24小时客服线上服务'=>'24-hour customer service online service',
    '如您在使用BingX的过程中遇到任何问题，可随时透过'=>'If you encounter any problems while using BingX, you can always go through',
    '咨询线上客服。如需即时帮助，您可点选萤幕右侧的“线上交谈”视窗转接全天候线上人工服务。'=>'Contact online customer service. If you need immediate assistance, you can click the "Online Chat" window on the right side of the screen to transfer to 24/7 online manual services.',
    '版权所有'=>'Copyright',
    '平台服务'=>'Platform service',
    '扫码下载'=>'Scan the QR code to download',
    '下载'=>'Download',
    '费率标准'=>'Rate Standard',
    '价格分析工具'=>'Price Analysis Tool',
    '汇率计算器'=>'Exchange rate calculator',
    '如何买币'=>'How to buy coins',
    '信息'=>'Information',
    '上币申请'=>'Application for currency listing',
    '成为P2P商户'=>'Become a P2P merchant',
    '讯号交易'=>'Signal Trading',
    '交易视图'=>'Trading View',
    '用户支援'=>'User Support',
    '新手帮助'=>'Newbie Help',
    '帮助中心'=>'Help Center',
    '功能建议'=>'Function Suggestions',
    'BingX经纪商计划'=>'BingX Broker Plan',
    '官方渠道验证'=>'Official channel verification',
    'VIP权益'=>'VIP Rights',
    '公司'=>'company',
    '关于我们'=>'About us',
    '加入我们'=>'Join us',
    ...
    '法律宣告'=>'Legal declaration',
    '风险提示'=>'Risk Warning',
    '加密货币、加密衍生品属于创新的金融产品，其价格具备巨大的波动性和较高的投资风险。'=>'Cryptocurrency and crypto derivatives are innovative financial products, and their prices are subject to huge volatility and high investment risks.',
    '尽管BingX尽力为您提供简单便捷的交易工具，但交易本身仍是一项专业度高的事情，无论您是交易现货或带有杠杆的衍生产品，或者购买理财产品，都有导致快速亏损甚至是损失所有本金的可能。您应该充分了解BingX所提供产品的主要功能和所涉及的主要风险，并始终审慎评估相关风险与您自身的风险承受能力是否匹配。如有必要，请在投资前寻求专业和独立的建议。您明确并同意您已阅读、理解并接受BingX所有条款。'=>'Although BingX strives to provide you with simple and convenient trading tools, trading itself is still a highly professional matter. Whether you are trading spot or leveraged derivatives, or purchasing financial products, there will be consequences. The possibility of rapid losses or even loss of all capital. You should fully understand the main functions and main risks involved in the products provided by BingX, and always carefully evaluate whether the relevant risks are consistent with your own risk tolerance. If necessary, please seek professional and independent advice before investing. You expressly and agree that you have read, understood and accepted all BingX terms. ',
     'Investing by following or copying the trades of others is extremely risky, even if you are copying or copying the trades of top traders.',
    '透过跟单或复制他人交易进行投资风险极高，即使跟单或复制的是顶级交易员的交易也是如此。
                        BingX社群成员过去的表现并非代表他未来表现。 BingX 作为您的加密社交交易平台，内容由其社群成员提供，并非BingX
                        提供或代表BingX 提供的建议或推荐。'=>'Investing by following or copying the trades of others is extremely risky, even if you are copying or copying the trades of top traders.
                          The past performance of a BingX community member is not indicative of his future performance. BingX is your crypto community trading platform. The content is provided by its community members, not BingX
                          Providing advice or recommendations by or on behalf of BingX.',
    ...
    '没有账号?'=>'No account?',
    '请输验证码'=>'Please enter the verification code',
    '验证码'=>'Verification code',
    '请输入信箱'=>'Please enter your password',
    '请输入信箱'=>'Please enter your email address',
    '信箱'=>'Mailbox',
    '登入'=>'Login',
    '赋能未来'=>'Empower the future',
    'BINGX 与蓝军携手合作。 通过加密货币和足球结合， 将创新、热情和才华汇聚，携手推动我们共同的目标，打造更为庞大、智慧和大胆的未来。'=>'BINGX works hand in hand with the Blues. Through the combination of cryptocurrency and football, innovation, enthusiasm and talent will be brought together to promote our common goals and create a bigger, smarter and bolder future.',
    '切尔西足球俱乐部官方加密货币交易所合作伙伴'=>'Official Cryptocurrency Exchange Partner of Chelsea Football Club',
    ...
    '感谢您访问Bingx-hg.com。通过浏览、访问或使用Bingx-hg.com以及相关移动应用程序（合为“BingX平台”)，您即（“用户”或“您”）同意本服务条款（本“条款”），因此请仔细阅读。<br><br>
根据您的居住地和注册日期：对于您和以下服务供应商（“我们”）之间任何或全部服务的使用，以及任何获得服务的方式，本条款构成一致协议和理解：<br><br>
BingX Bahamas FinTech Company Limited，一家注册在巴哈马的公司（“BingX 巴哈马”），适用于 2022 年 11月 16日至2023年8月28日期间注册的墨西哥居民用户，及于2023年8月29日之后注册的机构用户；<br><br>
BingX Serviços Digitais Ltda., 一家注册在巴西的公司（“BingX 巴西”），适用于 2023 年6月15日或之后注册的巴西居民用户；<br><br>
BingX SG Pte. Ltd., 一家注册在新加坡的公司（“BingX 新加坡”），适用于 2023 年 10 月 13 日或之后注册的新加坡居民用户；<br><br>
Aux Cayes FinTech Co. Ltd.， 一家注册在塞舌尔的公司（“Aux Cayes”），适用于有资格访问和使用 BingX 服务的所有其他用户。<br><br>
在本条款中使用“BingX”一词时，是指 BingX 巴哈马、BingX 香港、BingX 巴西、BingX 新加坡或Aux Cayes，依情形适用于其各自的用户。'=> 'Thank you for visiting Bingx-hg.com. By browsing, visiting or using Bingx-hg.com and related mobile applications (collectively, the "BingX Platform"), you (the "User" or "you") agree to these Terms of Service (these "Terms"), so please read them carefully. <br><br>',

    '1 序言'=> '1 Preface',

    '1.1 通过点击“创建账户”按钮或访问BingX平台，我们将通过软件、API（应用程序界面）、技术、产品和/或功能为您提供对我们交易平台的访问和使用。在本条款的第 4 条中规定了我们提供服务的描述。 在本条款的第 22条中规定了定义的术语列表及其含义。<br><br>
1.2 如本条款所述，您同意遵守本条款和所有通过引用并入的条款的法律约束。如果您不同意受到本条款的约束，请不要访问或使用本服务。 根据您是 BingX 巴哈马、BingX 香港、BingX 巴西、BingX 新加坡或Aux Cayes服务的用户，本条款中的某些条款会有所不同。 在该等情形下，相关条款将规定该条款适用于哪些用户。<br><br>
1.3 在适用法律法规允许的最大范围内及受制于第 16 条, 我们有权随时自行决定更改或修改本条款、及BingX平台上的任何政策或指南。<br><br>
1.4 在适用法律法规允许的最大范围内, 您同意放弃能够收到对这些改变或修改的特别通知的任何权利。您对本平台的继续使用将视作您同意这些改变或修改。如果您在访问或使用本平台时不同意现行条款，您必须停止使用我们的服务。我们建议您经常查阅条款，以确保您了解适用于您访问和使用服务的条款和条件。如果您对 BingX 平台的使用有任何问题，请联系帮助中心。<br><br>
...
(b) 禁止与在任何国家没有实体存在的银行或金融机构（即被禁止的“空壳银行”）或从事违反或可能导致 BingX 巴哈马、BingX 香港、BingX 巴西、BingX 新加坡或Aux Cayes（依适用）违反适用于我们或适用于相关受监管金融服务或活动的任何法律、法规或其他法律授权的金融活动或服务的银行或金融机构建立任何业务关系；<br><br>
...
4.14 BingX平台因下列状况无法正常运作，使用户无法使用各项服务或不能正常下单或撤单时，我们不承担损害赔偿责任，该状况包括但不限于：<br><br>
(a) 欧易BingX平台公告之系统停机维护期间；<br><br>
(b) 电信或网络设备问题；<br><br>
...
4.15 关于BingX在BingX平台上提供的服务：<br><br>
(a) 由于系统故障、平台系统漏洞、网络故障、分布式拒绝服务攻击（DDos）等黑客攻击等意外因素可能导致的异常交易、市场中断、以及其他可能的异常情况；或响应传票、法院命令或其他政府命令；或如果我们怀疑交易可能： 涉及洗钱、恐怖主义融资、欺诈或任何其他类型的金融犯罪；是错误的；或为本条款所禁止的使用相关，则我们保留自行决定处理或取消、更正、回滚和/或撤销任何数字资产交易或转让或取消任何异常交易结果的权利，即使在发生上述情形后资金已经自您的帐户中扣除。对于合约交易、C2C 和保证金贷款，我们有权利按照各用户协议中的描述回滚某一段时间的所有交易。在该等情形下，BingX 将撤消该交易并从您的账户中扣除相应的数字资产以弥补该交易造成的损失，我们没有义务以与取消的交易相同的价格或以相同的条款恢复买卖订单; 及/或<br><br>
(b) BingX严格禁止不公平的交易行为。 如果您参与以下行为，我们保留自行决定对您的帐户实施接管控制权的权利：<br><br>
(i) 参与价格操纵、内幕交易、市场操纵、市场扭曲或任何其他恶意的市场行为;<br><br>
(ii) 可能通过利用本服务的漏洞或其他不合理的手段损害其他用户或BingX;<br><br>
(iii) 参与BingX认为对市场有害的任何其他活动。<br><br>
...
4.17 用户同意，我们可以自行决定从 BingX 平台下架任何数字资产。<br><br>
4.18 关于交易异常处理，在使用本服务时，您同意并认可，可能由于数字资产网络连线问题或其他不可抗拒因素，造成本服务无法提供。用户确保所输入的您的资料无误，如果因资料错误造成BingX 平台于上述异常状况发生时，无法及时通知用户相关交易后续处理方式的，我们不承担任何损害赔偿责任。<br><br>
...
4.14 When the BingX platform cannot operate normally due to the following conditions, which prevents users from using various services or placing or canceling orders normally, we will not be liable for damages. This situation includes but is not limited to:<br><br>
(a) System shutdown and maintenance period announced by Ouyi BingX platform;<br><br>
...
4.15 About the services provided by BingX on the BingX platform:<br><br>
...
(b) BingX strictly prohibits unfair trading practices. We reserve the right, at our sole discretion, to take over control of your account if you engage in the following conduct:<br><br>
...
(ii) May harm other users or BingX by exploiting vulnerabilities in this service or other unreasonable means;<br><br>
(iii) Participate in any other activities that BingX deems to be harmful to the market. <br><br>
...
4.17 Users agree that we may remove any digital assets from the BingX platform at our sole discretion. <br><br>
4.18 Regarding transaction exception handling, when using this service, you agree and acknowledge that this service may not be provided due to digital asset network connection problems or other force majeure factors. The user ensures that the information entered is correct. If the BingX platform is unable to promptly notify the user of the subsequent processing of the relevant transaction when the above abnormal situation occurs due to data errors, we will not be liable for any damages. <br><br>
...
4.20 Any Digital Assets you purchase using your debit or credit card will be credited to your Account and our obligations in this regard will be deemed to be completed when the Digital Assets you purchase are reflected in your Account. We accept no responsibility for any losses that may occur thereafter. Once deposited, you are solely responsible for managing these digital assets. ',
    ...
    '5 BingX平台交易'=>'5 BingX platform trading',

    '5.1 用户可以通过在 BingX 平台上下达将一 (1) 种数字资产兑换为另一种数字资产的指令（“订单”）来购买或出售数字资产。<br><br>

5.2 用户在提交订单前应核实所有交易信息。用户确认并同意，用户自行负责确保订单的有效性和准确性，包括任何资产接收方的详细信息。 BingX不对用户在下单时未提供有效、准确信息的后果承担责任。<br><br>

5.3 BingX 平台每天二十四 (24) 小时、每周七 (7) 天和每年三百六十五 (365) 天均可访问，但除了进行定期维护或升级的任何时期，或如果 BingX 平台遇到意外或其无法控制的中断或中止。<br><br>

5.4 如果 BingX认为用户可能违反了适用的法律法规，BingX 可自行决定不进行通知即关闭用户账户，或暂停用户访问或使用 BingX 平台或服务，拒绝任何提交的订单，或对 BingX 平台上的交易金额进行限制。<br><br>

5.5 只有当用户的账户具有足够的资产来支付订单和任何相关费用时，用户才能使用 BingX 平台下订单。如果账户中的资产不足以在 BingX 平台上完成订单，则用户将无法在 BingX 平台上完成该订单。<br><br>
...
(b) 虽然 BingX 可以自行决定在某些特殊情况下撤销交易（包括但不限于违反适用法律法规或金融犯罪），但用户无权撤销交易.<br><br>

5.8 BingX 将在用户每次下订单、取消订单以及订单部分或全部履行时，通过电子邮件、通知或本条款规定的任何其他通信方式向用户发送确认。<br><br>

5.9 通过订立本条款，用户确认并同意：<br><br>

(a) 通过在 BingX 平台上进行交易，用户指示 BingX 以用户在BingX 平台上下单的报价的买入价或卖出价进行交易，并且用户同意支付任何相关费用。除非本条款中明确规定，交易的价格应为用户与该交易的另一方同意的价格，BingX 不应作为该交易的一方或负责设定或协商交易的价格。用户不得就该等交易向 BingX 索赔。 BingX 不保证任何拟进行的数字资产买卖交易的完成；<br><br>

(b) BingX 基于价格时间优先性进行交易；<br><br>

(c) 其与 BingX 平台的任何其他用户享有相同的价格时间优先性；<br><br>

(d) 通过 API 提交的订单与从 BingX 平台收到的订单具有相同的价格时间优先性；<br><br>

(e) 通过借记和贷记双方账户中的相关资产余额，所有已成交的订单立即结算。用户将通过 BingX 平台和/或通过电子邮件或任何其他约定的通信方式立即收到其相关交易通知，并且可以在用户的交易历史中查询；<br><br>

(f) API 使用户能够将实时价格流式传输到其自己的用户界面中，以及执行相同的交易或下达用户在 BingX 平台上可用的相同订单；<br><br>

(g) 特别是对于 BingX 新加坡的用户而言，每个用户交易的交易对手均为 BingX 新加坡；<br><br>

(h) 为了维护公平有序的 BingX 平台，BingX 可能会限制通过 API 允许的订单数量并通过 API 监控消息，以：<br><br>

(i) 保护 API 免受拒绝服务攻击；<br><br>

(ii) 防止滥用订单簿；和<br><br>

(iii) 改善 BingX 平台的整体交易体验。<br><br>

5.10 BingX 可能会限制通过用户账户下达的订单数量。<br><br>

5.11 API的使用应用于合法的交易目的，任何反复违反订单率限制的行为将导致BingX根据本款暂停或关闭用户的账户。<br><br>

5.12 BingX平台提供的交易记录是用户交易的真实准确记录。用户有责任及时了解其交易历史和用户帐户相关的任何通知。<br><br>

5.13 用户理解并同意，由于 BingX 的安全交易协议要求使用在线和离线存储相结合的方式安全存储数字资产私钥以增加安全性，因此在 BingX 平台上执行交易可能会出现延迟。'=>'5.1 Users can buy or sell digital assets by placing an instruction ("Order") to exchange one (1) digital asset for another digital asset on the BingX platform. <br><br>
...
5.4 If BingX believes that the user may have violated applicable laws and regulations, BingX may, at its sole discretion and without notice, close the users account, suspend the users access to or use of the BingX platform or services, reject any submitted order, or impose any additional charges on the transaction amount on the BingX platform. Make restrictions. <br><br>

5.5 Users can place orders using the BingX platform only if the users account has sufficient assets to cover the order and any related fees. If the assets in the account are insufficient to complete the order on the BingX platform, the user will not be able to complete the order on the BingX platform. <br><br>
...
(b) Although BingX may, at its sole discretion, revoke transactions under certain special circumstances (including but not limited to violations of applicable laws and regulations or financial crimes), users do not have the right to revoke transactions.<br><br>

5.8 BingX will send a confirmation to the User via email, notification or any other communication method specified in these Terms each time the User places an order, cancels an order and fulfills part or all of an order. <br><br>

5.9 By entering into these Terms, the user confirms and agrees:<br><br>

(a) By trading on the BingX platform, the user instructs BingX to trade at the buying or selling price quoted by the user on the BingX platform, and the user agrees to pay any relevant fees. Except as expressly provided in these Terms, the price of a transaction shall be the price agreed between the user and the other party to the transaction, and BingX shall not be a party to the transaction or be responsible for setting or negotiating the price of the transaction. Users shall not make any claim against BingX for such transactions. BingX does not guarantee the completion of any proposed digital asset purchase and sale transactions;<br><br>

(b) BingX trades based on price-time priority;<br><br>

(c) It enjoys the same price time priority as any other user of the BingX platform;<br><br>

(d) Orders submitted through the API have the same price-time priority as orders received from the BingX platform;<br><br>
...
(f) The API enables users to stream live prices into their own user interface, as well as execute the same trades or place the same orders available to users on the BingX platform;<br><br>

(g) Especially for users of BingX Singapore, the counterparty of each users transaction is BingX Singapore;<br><br>

(h) In order to maintain a fair and orderly BingX platform, BingX may limit the number of orders allowed through the API and monitor messages through the API to:<br><br>

(i) Protect APIs from denial of service attacks;<br><br>

(ii) prevent order book abuse; and<br><br>

(iii) Improve the overall trading experience of the BingX platform. <br><br>

5.10 BingX may limit the number of orders placed through a User Account. <br><br>

5.11 The use of API should be used for legitimate trading purposes. Any repeated violation of order rate limits will result in BingX suspending or closing the users account in accordance with this paragraph. <br><br>

5.12 The transaction records provided by the BingX platform are true and accurate records of user transactions. It is the users responsibility to keep abreast of their transaction history and any notifications related to their user account. <br><br>
...
5.15 Users can be notified in advance of the maintenance suspension time through online announcements and other means. ',
    ...
    '5.16 用户确认并同意， 当BingX自行决定出现下述情况时，BingX 有权自行决定暂停全部或部分服务，或用户访问全部或部分服务的权限：<br><br>

(a) 用户可能违反了本条款；或<br><br>

(b) BingX 平台的正常运行受到威胁。<br><br>

5.17 为第 5.16(b) 条之目的，BingX 平台的正常运行将在以下情形下受到威胁：<br><br>

(a) 当计算机或电信网络因事故而停止运行或运作时；<br><br>

(b) 发生影响服务提供的不可抗力事件；<br><br>

(c) 当 BingX 的资产或用户的资产或 BingX 平台成为企图或实际恶意攻击的对象时，并可能导致该等资产被盗或丢失；<br><br>

(d) 当事件影响 BingX 平台所依赖的关键系统（包括定价系统或提供服务所需的任何其他系统）的正常运行时；<br><br>

(e) 当 BingX 怀疑未经授权使用 BingX 平台，或违反本条款或适用法律法规时；<br><br>

(f) 当 BingX 自行决定认为有必要根据适用法律法规的要求进行调查或确保 BingX 平台正常运行时；<br><br>

(g) 当 BingX 决定停止处理基于硬分叉导致分链或数字资产变更的数字资产时；<br><br>

(h) 当 BingX 认为由于适用法律法规的变化、社会状况或 BingX 无法控制的因素而无法继续提供服务时，包括但不限于数字资产不再被有权机构视为"可接受的数字资产"时；或<br><br>

(i) 当出于任何其他原因时，BingX 自行决定暂停是必要的。'=>'5.16 The user confirms and agrees that when BingX determines at its sole discretion that the following circumstances occur, BingX has the right to suspend all or part of the service, or the users access to all or part of the service:<br><br>

(a) User may have violated these Terms; or<br><br>

(b) The normal operation of the BingX platform is threatened. <br><br>

5.17 For the purpose of Article 5.16(b), the normal operation of the BingX Platform will be threatened under the following circumstances:<br><br>
...
(c) When BingXs assets or users assets or the BingX platform become the target of attempted or actual malicious attacks, which may result in the theft or loss of such assets;<br><br>

(d) When an event affects the normal operation of key systems on which the BingX platform relies (including pricing systems or any other systems required to provide services);<br><br>

(e) When BingX suspects unauthorized use of the BingX platform, or violation of these Terms or applicable laws and regulations;<br><br>

(f) When BingX determines in its sole discretion that it is necessary to investigate or ensure the normal operation of the BingX platform in accordance with the requirements of applicable laws and regulations;<br><br>

(g) When BingX decides to stop processing digital assets based on hard forks that lead to changes in chain or digital assets;<br><br>

(h) When BingX believes that it is unable to continue to provide services due to changes in applicable laws and regulations, social conditions or factors beyond BingXs control, including but not limited to when digital assets are no longer considered acceptable digital assets by competent authorities ;or<br><br>
...
(i) When suspension is necessary for any other reason in BingX’s sole discretion. ',
    ...
    '6.1 本第 6 条向用户提供与数字资产交易和 BingX 提供的任何其他服务相关的风险信息。申请人和用户在申请开立账户和执行交易之前应仔细阅读本风险声明。本风险声明应与风险披露和免责声明一起阅读。<br><br>

6.2 本第 6 条无意披露或详细讨论与交易或持有数字资产或使用 BingX 提供的服务相关的所有风险。本风险声明并非详尽无遗，仅概述了所涉及风险的一般性质。用户应确保其决定是在充分知情的基础上作出的，并且用户应根据自己的经验、目标、财务资源及其特定需求和要求对数字资产交易的适用性进行自己的评估。<br><br>

6.3 用户开立账户并进行交易，即视为用户已审阅、理解并接受与BingX提供的服务相关的风险。<br><br>

6.4 数字资产市场非常新且发展迅速，交易该等资产的风险尚未完全了解。因此，BingX 可能会定期更新本风险声明，并不时通知用户，以列出数字资产交易中的其他风险，但即使风险声明中未涉及某风险，BingX不承担任何责任。<br><br>

6.5 用户确认并同意，用户有责任及时了解 BingX 不时发布的更新的风险声明。'=>'6.1 This Article 6 provides users with risk information related to digital asset trading and any other services provided by BingX. Applicants and users should read this risk statement carefully before applying to open an account and execute transactions. This risk statement should be read in conjunction with the risk disclosures and disclaimers. <br><br>
...
6.3 By opening an account and conducting transactions, the user is deemed to have reviewed, understood and accepted the risks associated with the services provided by BingX. <br><br>

6.4 The digital asset market is very new and developing rapidly, and the risks of trading these assets are not yet fully understood. Therefore, BingX may regularly update this risk statement and notify users from time to time to list other risks in digital asset transactions, but even if a risk is not covered in the risk statement, BingX does not assume any responsibility. <br><br>
...
6.18 Users are deemed to have assessed and confirmed that they understand the risks involved before opening an account. ',
    ...
    '6.20 BingX 提供仅执行服务，而不就任何特定交易的优点、交易风险或相关税务后果提供建议，并且 BingX 不提供与服务相关的任何其他财务、投资或法律建议。<br><br>

6.21 BingX 作为交易执行订单和托管数字资产的平台。如第 4.6 条所述，BingX 及其关联方可能从事某些交易活动。<br><br>

6.22 因此，BingX 不负责评估是否：<br><br>

(a) 服务适合用户；或<br><br>

(b) 交易适合用户的需求。<br><br>

6.23 BingX 平台上提供的任何信息仅供参考，并非、也不拟作为财务建议、投资建议、财务咨询服务、交易建议或任何其他建议。 BingX 不保证该等信息的准确性、完整性或有用性，并且该等信息不应被视为购买或出售数字资产的要约。用户应自行负责确定任何交易是否合适。<br><br>

6.24 通过开立账户，用户接受数字资产交易的风险。在进行任何交易时，用户表示他们已经、现在并且将自行负责对每笔交易和基础数字资产的风险进行独立评估和调查。<br><br>

6.25 通过使用 BingX 的服务，各用户陈述其有足够的知识、市场成熟度、专业建议和经验，可以在开户前自行评估任何交易或任何基础数字资产的优点和风险。<br><br>

6.26 各用户必须确保在必要时寻求专业建议，同时考虑到他们的投资目标、经验水平和风险承受能力。<br><br>

6.27 各用户都应充分了解与用户计划交易的特定数字资产相关的特定特征和风险。'=>

'6.20 BingX provides execution services only and does not provide advice on the merits of any particular transaction, transaction risks or related tax consequences, and BingX does not provide any other financial, investment or legal advice in connection with the Services. <br><br>

6.21 BingX serves as a platform for transaction execution orders and custody of digital assets. As described in Section 4.6, BingX and its affiliates may engage in certain trading activities. <br><br>

6.22 Accordingly, BingX is not responsible for assessing whether:<br><br>
...
6.25 By using BingXs services, each user states that they have sufficient knowledge, market maturity, professional advice and experience to evaluate the advantages and risks of any transaction or any underlying digital assets by themselves before opening an account. <br><br>
...
6.27 Each user should fully understand the specific characteristics and risks associated with the specific digital assets that the user plans to trade. ',
    ...
    '6.28 用户使用 BingX 平台购买数字资产的能力可能取决于是否存在愿意出售相同数字资产的交易对手（反之亦然）。这不在 BingX 的控制范围内。 BingX 不保证通过 BingX 平台购买或出售数字资产的时间或可使用该服务。<br><br>
...
6.31 "分叉"是指区块链网络代码的升级，例如，这可能是由于利益相关方之间对数字资产协议的更新存在分歧，或者是有意恢复区块链历史至网络攻击之前的某个时间点。硬分叉可能会导致与先前版本的区块链永久分离，并将有效地创建新的数字资产。分叉的发生不在 BingX 的控制范围内。由于数字资产协议的分叉或类似更改而导致的数字资产供应以及由此导致的BingX 就新数字资产提供服务的能力可能取决于 BingX 无法控制的第三方提供商。 BingX 不拥有或控制与数字资产及其相关网络相关的任何协议。因此，BingX 对该等协议或任何数字资产价值的任何变化（无论是由于分叉或数字资产协议的任何类似变化或其他原因）不承担任何责任，并且 BingX<br><br> 对安全性、功能或该等协议的可用性不作任何保证。
...
6.35 If you exchange a digital asset after executing an order, or the order is denominated in a digital asset other than your primary reference asset, there is the potential for a net gain at expiration or earlier if the market moves against your position. There is a risk that the initial amount of your primary reference asset is significantly less than the initial amount and any income or gains may be completely offset. ',
    ...
    '6.36 BingX 可能与第三方持有法币和数字资产。但是，BingX 持有的数字资产不是"存款"，也不拟作为适用法律下的任何其他受监管产品或服务而持有。<br><br>

6.37 在适用法律法规或相关司法管辖区的市场惯例允许的某些情况下，BingX 可以以托管人的名义或 BingX 的名义注册或记录用户账户。如果账户以托管人或 BingX 的名义持有，则该等资产可能不会与 BingX 的资产隔离，并且在托管人或 BingX 违约的情况下，可能无法如同用户的客户资产与托管人的资产或 BingX 的资产隔离一样，妥善的保护其免受托管人的债权人或 BingX 的债权人的索赔。特别是对于 BingX 新加坡的用户，为了用户的利益，用户的资产被托管在一个或多个独立的托管账户中。<br><br>

6.38 如果持有用户法币和/或数字资产的第三方出现破产或任何其他类似程序，BingX 只能代表用户向第三方提出无担保索赔，并且用户可能会被面临BingX从第三方收到的法币、数字资产或任何其他财产不足以满足用户和所有其他相关用户的索赔的风险。<br><br>

6.39 如果 BingX 将用户的法币和/或数字资产存入第三方，则该等法币和/或数字资产可能与属于其他用户的法币和/或数字资产合并。在这种情况下，用户的个人客户权利可能无法通过单独的证书、其他所有权文件或同等电子记录单独识别，并且如果在 BingX 破产后出现无法避免的亏损，任何资产已被归集的用户可能按其在资产中的原始资产所占比例分担该亏损。与归集资产相关的任何权利或其他利益将按比例分配给资产各相关用户。<br><br>

6.40 法币和/或数字资产可能由 BingX或BingX 的代理人或分托管人善意指定的第三方持有。该等第三方不受 BingX 的控制，BingX 对该等第三方的任何性质的违约不承担任何责任，如果发生该等违约，用户可能会就用户账户遭受全部或部分损失。用户在相关司法管辖区收回其法币和/或数字资产的程度可能受特定法律或当地法规的约束。'=>'6.36 BingX may hold fiat currencies and digital assets with third parties. However, digital assets held by BingX are not "deposits" and are not intended to be held as any other regulated product or service under applicable law. <br><br>
...
6.40 Legal currency and/or digital assets may be held by BingX or a third party designated in good faith by BingXs agent or sub-custodian. Such third parties are not under the control of BingX, and BingX is not responsible for any breach of contract of any nature by such third parties. If such a breach occurs, the user may suffer all or part of the loss in relation to the user account. The extent to which users can recover their fiat currency and/or digital assets in relevant jurisdictions may be subject to specific laws or local regulations. ',
    ...
    'BingX 平台交易的风险'=>'Risks of trading on the BingX platform',

    '6.41 与法币和证券等其他类型的资产相比，任何数字资产交易可能不适用任何政府或监管机构设立的任何投资者赔偿基金的索赔权；此外，在 BingX 账户中持有的数字资产可能不是受保护的存款，也可能不受任何相关司法管辖区的任何存款保护计划的保护。因此，与法币、证券和其他资产类别和类型相比，数字资产的保护级别和类型可能有所降低。<br><br>
...
6.44 请注意，BingX 收到或持有的数字资产可能受您居住国和/或国籍国以外的国际司法管辖区的其他适用法律的约束。<br><br>

6.45 允许他人交易或操作您在我们平台的账户存在重大风险，并且您提供的任何指令都可能未经适当授权或执行。您接受该等操作的所有风险，并完全且不可撤销地免除 BingX 因上述所有内容引起或与之相关的任何和所有责任。<br><br>

6.46 数字资产交易是不可逆的。因此，与数字资产有关的意外或欺诈交易可能无法恢复。因此，您在进行任何数字资产转移时必须谨慎行事，并对可能出现的任何损失承担全部责任。<br><br>

6.47 在 BingX 平台上的订单在完成本条款中所述步骤后具有约束力。除非本条款另有规定，否则不会保留订单。最终的有约束力的订单可能不会与您的指示同时发生。因此，您可能会因订单未在所需时间执行而遭受损失。特别是，由于市场条件的波动，期权或永续合约等或有订单可能不会将您的损失限制在预期金额。<br><br>

6.48 存在未经授权的第三方可能会在您不知情或未经授权的情况下访问您的账户并进行交易的真正风险，无论是通过获得对您使用的设备或账户的控制权还是通过其他方式。<br><br>

6.49 BingX 没有义务对 BingX 平台上提供的材料和信息进行任何变更、增强和/或修改。因此，例如，您的 BingX 应用程序版本可能已过时，并且您使用的应用程序版本可能未包含新功能。您有责任确保更新和下载适用的更新和版本。'=>'1111',
...
6.44 Please note that digital assets received or held by BingX may be subject to other applicable laws in international jurisdictions other than your country of residence and/or citizenship. <br><br>
...
6.52 You may store your digital assets in hot wallets, but such hot wallets may be exposed to hacker attacks, network attacks or any of the risks mentioned in Section 6.51. Unfortunately, disruptions, thefts, cyberattacks and hacks of digital asset trading platforms, and theft of digital assets are all too common. Victims may face extremely difficult difficulties in recovering losses from hackers, trading platforms, or other related industry organizations and/or individuals. This may result in significant losses and other adverse effects that may materially affect your interests. ',
    ...
    '6.53 理解数字资产需要先进的技术知识。数字资产通常以极其技术性的语言描述，需要对应用密码学和计算机科学有全面的了解才能理解固有风险。数字资产在 BingX 平台上的上架并不表示 BingX 同意或不同意该数字资产的相关基础技术，并且不应替代每个用户对与该数字资产相关的风险的理解。<br><br>

6.54 数字资产的基础软件协议通常是开源项目，这意味着：<br><br>

(a) 该等数字资产的开发和控制不在 BingX 的控制范围内；及<br><br>

(b) 该等软件协议可能会发生突然而剧烈的变化，这些变化可能会对特定数字资产的可用性、应用性或价值产生重大影响。<br><br>

6.55 数字资产的性质意味着 BingX 遇到的技术困难可能会阻止用户访问或使用其数字资产。 BingX 可能会遇到复杂的网络攻击、意外的活动激增或其他可能导致服务中断或可能导致数字资产丢失和/或被盗的操作或技术困难。用户应理解服务可能会遇到导致延迟的操作问题。通过使用服务，用户同意接受因意外或加剧的技术困难导致交易失败的风险，包括因复杂攻击而导致的交易失败风险。<br><br>

6.56 数字资产依赖于新技术，包括以实现匿名性、交易不可逆性、意外交易、交易记录和结算等目的分布式账本技术。<br><br>

6.57 数字资产交易不可撤销。一旦用户将数字资产发送到 BingX 平台之外的钱包地址，存在用户可能会永远地失去对数字资产的访问权限的风险。例如，钱包地址可能被输入错误，钱包地址的真正所有者可能永远不会被发现，或者钱包地址可能属于不会归还用户数字资产或仅在用户采取行动后才会归还的主体，例如验证其身份。<br><br>
...
6.60 在越狱设备上使用 BingX 平台可能会危及安全并导致欺诈交易。您可能会遭受损失以及服务的终止。<br><br>

6.61 数字资产和BingX平台依赖于互联网和其他技术（包括各种通信方式和媒介）。然而，互联网的公共性质意味着部分或整个互联网在任何特定时间都可能不可靠或不可用。此外，在通过互联网和/或其他技术传输数据时，可能会发生数据中断、延迟、损坏或丢失、数据传输过程中保密性或隐私的丢失或恶意软件传输。上述情况可能会导致您的交易在要求的时间无法按照您的指示执行，或者根本没有执行。<br><br>

6.62 没有完全安全的技术。因此，您在使用任何技术时都应谨慎行事。<br><br>

6.63 互联网以及其他电子媒体（包括但不限于电子设备、第三方电信服务提供商提供的服务，如手机或其他手持交易设备或交互式语音响应系统）是一种固有的不可靠的通信形式，并且这种不可靠性可能超出 BingX 的控制范围。<br><br>
...
(a) The development and control of such digital assets are beyond the control of BingX; and<br><br>
...
6.60 Using the BingX platform on jailbroken devices may compromise security and lead to fraudulent transactions. You may suffer losses and termination of service. <br><br>
...
6.67 BingX 可能会暂停用户对其账户的访问。在这种情况下，用户将无法进行转入、转出或交易。 BingX 也可能会暂停用户在 BingX 平台上进行交易的能力，在这种情况下，将无法进行数字资产的买卖，但可以从其账户中进行转入或转出。<br><br>
...
6.79 我们无义务随时通知您您的账户余额和所需保证金（即"追加保证金"）。但是，如果我们进行通知，追加保证金通知可以通过电话、邮寄、电子邮件、短信或通过您的 BingX 平台进行。<br><br>

6.80 我们有权在任何时候并在短时间内，增加或减少您对未平仓交易的保证金要求。您同意，无论您和我们采用何种正常沟通方式，我们都有权通过以下任何方式通知您账户的保证金水平或信用安排的变化：电话、电子邮件、短信、通过我们的 BingX 平台上发布变更通知。保证金水平的任何增加都将根据我们的要求立即到期应付。我们只会在我们自行决定合理认为必要时增加保证金要求或变更您账户的信用安排，包括但不限于由于发生或预计发生下列情形：<br><br>
...
6.82 请注意，在某些情况下，我们可能会触发分摊机制，以从您的收益中提取一部分以弥补任何损失。当 BingX 的风险保险资金无法弥补用户的损失时，会触发分摊机制。在该等情况下，BingX 将使用其分摊机制从其他用户追回净利润以弥补不足。有关分摊机制的更多信息，请参见此处。<br><br>
...
6.79 We are under no obligation to notify you of your account balance and required margin (i.e., "Margin Call") at any time. However, if we make a notification, the margin call can be made by phone, post, email, text message or through your BingX platform. <br><br>
...
6.82 Please note that in certain circumstances we may trigger a splitting mechanism to take a portion of your earnings to cover any losses. When BingXs risk insurance funds cannot cover the users losses, the sharing mechanism will be triggered. In such cases, BingX will use its sharing mechanism to recover net profits from other users to make up for the shortfall. More information on the apportionment mechanism can be found here. <br><br>
...
6.84 In certain circumstances or circumstances, closing a position in a digital asset may be difficult or even impossible to close. Certain events that occur on the network may occur rapidly and affect the ability to conduct transactions on the BingX platform. Information related to these cyber events may be difficult to predict or determine in advance and may be subject to limited oversight by any third party capable of intervening to stabilize the network. ',
    ...
    '6.85 网站和互联网页面、投资者关系发布、口头或书面展望、演示文稿、事件的音频和视频记录以及来自网站的其他出版物可能包含反映 BingX 及其管理层当前对潜在项目的看法的乐观、前瞻性陈述和事件。某些表述，包括但不限于"预期"、"假设"、"相信"、"估计"、"预计"、"打算"、"可能"、"计划"、"项目"和"应该"，以及其他经常识别前瞻性陈述的表达方式。这些表述可能会由于多种因素的影响而受制于风险、不确定性和变化，包括但不限于：数字资产和法币汇率、利率和商品价格的变化；引入新的和/或竞争的技术和想法；增加市场激励；以及对当前服务或其他产品的需求下降。'=>'6.85 The Website and Internet pages, investor relations releases, oral or written outlooks, presentations, audio and video recordings of events and other publications from the Website may contain statements that reflect the current optimism of BingX and its management regarding potential projects, Forward-Looking Statements and Events. Certain expressions, including, but not limited to, "anticipate," "assume," "believe," "estimate," "anticipate," "intend," "may," "plan," "project," and "should" and others Expressions that often identify forward-looking statements. These statements may be subject to risks, uncertainties and changes due to a variety of factors, including but not limited to: changes in digital asset and fiat currency exchange rates, interest rates and commodity prices; the introduction of new and/or competitive technologies and ideas ; increased market incentives; and decreased demand for current services or other products. ',

    '7 创建账户'=>'7 Create account',

    '7.1 账户注册和身份验证：为了使用本平台任何服务，您应提供注册页面所需填入的准确的全部信息以进行身份验证，并确认接受本服务条款。除非获得 BingX 的批准，通过在 BingX 注册账户，您同意并声明您将仅为自己使用该账户，而不代表任何第三方。<br><br> 您同意提供给我们因身份验证、和因反洗钱反恐怖融资、诈骗、或其他金融犯罪监控的持续原因考虑，而在注册时要求提供的真实的信息，包括但不限于您带有照片的官方身份证明副本、住址证明，如物业账单或银行账单。如果相关信息发生改变，您有义务尽快进行更新。<br><br>
...
7.5 帐户关闭：您可以随时向BingX要求关闭您的帐户。关闭账户不会影响账户关闭日期之前发生的任何权利和义务。在BingX关闭您的账户之前，您可能被要求取消或完成所有未完成的订单，并根据本条款的规定，提供转账指令，说明您的账户中剩余的任何法币和/或数字资产的转移位置。您对您的账户关闭所产生的任何费用、成本或义务（包括但不限于律师和法院费用或法币或数字资产的转账费用）负责。如果您的账户关闭费用超过您账户的价值，您将负责偿付我们。您不可以为了避免支付任何其他费用或避免任何与我们的反洗钱计划相关的检查，而去关闭您的任何账户。 BingX 保留自行决定接受或拒绝账户关闭请求的绝对权利。<br><br><br><br>

7.6 帐户暂停：我们有权随时暂停您的帐户。并且，如果我们自行决定怀疑存在以下情形，我们有权冻结/锁定任何您的账户中的资金和资产，并暂停您对本站的部分或所有访问权限：<br><br>

(a) 您/您的账户或其操作违反本条款的任何条款或条件、任何BingX的其他政策、规则、规定、用户协议或程序，包括但不限于BingX反洗钱计划；<br><br>
...
(a) 根据涉及您账户的活动，您欠任何一方（包括但不限于 BingX）的任何交付、付款或其他义务应到期、累积或以其他方式加速履行，以便要求在该等违约事件发生之日履行该等义务("加速义务")； 和<br><br>

(b) 在不损害 BingX 根据本条款或其他规定可能产生的其他权利的情况下，BingX 有权自行决定采取一切认为必要的行动来保护其利益并要求履行加速义务，包括但不限于平仓任何敞口交易头寸，清算您账户中的资产以偿还欠 BingX 的任何款项和其他可清算义务，并根据法院命令将资产转让给第三方。'=>'7.1 Account registration and identity verification: In order to use any services on this platform, you should provide all accurate information required on the registration page for identity verification and confirm acceptance of these Terms of Service. Unless approved by BingX, by registering an account with BingX, you agree and declare that you will only use the account for yourself and not on behalf of any third party. <br><br> You agree to provide us with the true information requested during registration for identity verification and for ongoing monitoring of anti-money laundering, counter-terrorism financing, fraud, or other financial crimes, including but not limited to A copy of your official photo ID, proof of address such as a property bill or bank statement. If relevant information changes, you are obliged to update it as soon as possible. <br><br>
...
(a) You/your account or its operation violates any term or condition of these Terms, any other policies, rules, regulations, user agreements or procedures of BingX, including but not limited to BingX’s anti-money laundering program;<br><br>
...
9.3 您不得以任何导致或可能导致BingX 平台损坏或损害BingX 平台可用性或可访问性的方式使用BingX 平台或服务;或以与以下行为或活动相关的方式使用BingX 平台或服务，即任何非法资金支付和结算活动，包括但不限于以虚假交易，虚假价格和交易退款等非法手段进行的非法支付活动; 单位银行结算账户非法套现活动; 单位银行结算账户非法转个人账户活动; 非法支票兑现活动；或其他任何为实现非法，欺诈或有害目的活动；或其他任何违反现行有效的法律法规的活动。您保证Aux Cayes、BingX 香港、BingX 巴西、BingX 巴哈马、BingX 新加坡及其管理人员、董事、股东、利益承继方、员工、代理人、子公司、关联方及BingX 平台以前的运营方，不因您使用BingX 平台或服务的行为或与之相关的行为，而承担第三方针对Aux Cayes、BingX 香港、BingX 巴西、BingX 巴哈马、BingX 新加坡或其关联方所提起的任何权利要求、索赔要求、或其他承担责任的要求，否则您同意赔偿上述各方因此产生的损失和费用（包括律师费）。<br><br>

9.4 禁止您以任何形式利用本站从事非法活动。未经欧易BingX的授权或许可，您不得借用本站的名义从事任何商业活动，也不得以任何形式将本站作为从事商业活动的场所、平台或媒介。<br><br>

9.5 您应遵守所有法律法规，并对涉及本站和服务的自己的行为承担相应法律后果和责任。另外，您不应侵犯任何第三方的合法权利和利益。此外，如果欧易BingX因此受到损失，欧易BingX有权通过法律或其他途径向您追偿损失。<br><br>
...
9.5 You should abide by all laws and regulations, and bear the corresponding legal consequences and responsibilities for your actions involving this site and services. In addition, you shall not infringe the legal rights and interests of any third party. In addition, if Ouyi BingX suffers losses as a result, Ouyi BingX has the right to recover the losses from you through legal or other means. <br><br>
...
10.2 欧易BingX有权自行决定设置和调整服务费用。我们也有权对免费服务开始收费。所有费用的变更都将提前公告。<br><br>
...
10.2 OUYI BingX has the right to set and adjust service fees at its sole discretion. We also reserve the right to charge for free services. All fee changes will be announced in advance. <br><br>
...
(c) 如果您/您的账户违反本条款的任何条款或条件、任何BingX的其他政策、规则、规定、用户协议或程序，包括但不限于BingX反洗钱计划;<br><br>
...
(c) If you/your account violates any term or condition of these Terms, any other policies, rules, regulations, user agreements or procedures of BingX, including but not limited to BingX’s anti-money laundering program;<br><br>
...
(f) If we determine in our sole discretion that it is for security reasons or other necessary circumstances to protect your account and prevent unauthorized access, etc. ',
    ...
    'BingX 的义务'=>'BingXS OBLIGATIONS',

    '如果您的账户中有 BingX 持有的任何资产，并且在不少于十二 (12) 个月或在相关司法管辖区的适用法律或法规要求的时间内，BingX 无法与您联系并且该期限内没有您使用服务的记录，BingX 可能需要根据适用法律法规将这些资金报告为无人认领的财产。 BingX 将尽合理努力使用 BingX 可用的联系信息找到您。<br><br>

12.1 如果 BingX 无法找到您，BingX 保留以下权利：<br><br>

(a) 关闭您的账户并终止本条款；及<br><br>

(b) 按照有权机构或任何有管辖权的法院的指示，将所有资产作为无人认领的财产交付。<br><br>

12.2 如果我们收到任何确认您死亡的文件或其他导致 BingX 认为您已经死亡的信息，BingX 保留冻结您账户的权利。<br><br>

12.3 发生下列情形之一，您的帐户将被解冻：<br><br>

(a) 当您的指定受托人开立新账户时，如下文第 12.5 条所述，并且您的全部账户已转移至该新账户，或<br><br>

(b) BingX 已收到我们满意的证明，证明您没有死亡。<br><br>

12.4 如果 BingX 有理由相信您可能已经死亡，但没有以 BingX 满意的形式证明您的死亡，您授权 BingX 直接或通过第三方进行我们认为有必要确定您是否已经死亡的查询. BingX 收到令 BingX 满意的证明您已死亡的证据后，您在有效遗嘱或类似遗嘱文件中指定的受托人将被要求开立新账户。<br><br>

12.5 如果您未指定受托人，BingX 保留将任何有权继承您账户的人士视为您的受托人的权利，BingX 将根据BingX收到并审查 BingX 自行决定认为必要或适当的文件确定有权继承您账户的人士，该等文件包括但不限于遗嘱、生前信托或其他类似文件，或对您的财产具有有效管辖权的法院指定受托人的命令。<br><br>

12.6 如果 BingX 自行决定确定受托人指定的有效性存在不确定性，BingX 保留在采取与您的账户有关的任何行动之前要求有管辖权的法院下达解决该问题的命令的权利。'=>'If you have any assets held by BingX in your account and BingX is unable to contact you for a period of not less than twelve (12) months or as required by applicable laws or regulations in the relevant jurisdiction and that period There is no record of your use of the Services, and BingX may be required to report these funds as unclaimed property in accordance with applicable laws and regulations. BingX will use reasonable efforts to locate you using contact information available to BingX. <br><br>

12.1 If BingX cannot find you, BingX reserves the following rights:<br><br>
...
12.2 If we receive any documents confirming your death or other information that causes BingX to believe that you are dead, BingX reserves the right to freeze your account. <br><br>
...
(b) BingX has received certification to our satisfaction that you are not dead. <br><br>
...
12.6 If BingX determines, in its sole discretion, that there is uncertainty as to the validity of the trustee appointment, BingX reserves the right to request an order from a court of competent jurisdiction that resolves the issue before taking any action related to your account. ',
    ...
    '12.7 BingX 有权从任何法币中扣除与本第 12 条相关的所有成本和费用。'=>'12.7 BingX shall be entitled to deduct all costs and expenses related to this Article 12 from any legal currency.',
...
13.3 When using our services, you confirm, state and promise that all your actions inside and outside the BingX platform are conducted in a legal and appropriate manner, and that the source of your digital assets and legal currency does not come from illegal activities. If we, in our sole discretion, believe that you have violated the above representations and commitments, we may, at our sole discretion or in coordination with local law enforcement agencies, seize, freeze, restrict or close your account and any fiat currency and digital assets held in your account. ',
    ...
    '15.1 BingX 及其任何关联方均不对因以下原因直接或间接产生的任何损失承担责任：<br><br>
...
您在此放弃并解除向 BingX 和/或其关联方索赔任何该等损失的任何权利。'=>'15.1 Neither BingX nor any of its affiliates shall be liable for any losses arising directly or indirectly from:<br><br>
...
You hereby waive and release any right to claim any such losses from BingX and/or its affiliates. ',
    ...
    '15.2 在适用法律法规允许的最大范围内，对用户可能因由 BingX 及其关联方提供或代表 BingX 及其关联方在BingX 平台提供的信息或材料引起或与之相关的损失，BingX承担的全部责任的总价值不得超过 100 美元。<br><br>

15.3 在适用法律法规允许的最大范围内，BingX 对于以下所产生的单个索赔或一系列索赔而产生的损失的责任的总价值：<br><br>
...
(iii) 由 BingX 和/或其关联方提供或代表 BingX 和/或其关联方提供的任何信息或材料（第 15.3 条中提及的信息或材料除外）；或<br><br>
...
(b) 用户在前十二 (12) 个月期间就服务向 BingX 支付的总费用（"上限"）。<br><br>

15.4 如果发生与特定交易相关的索赔，BingX、其股东、关联方或服务提供商及其各自的管理人员、董事、雇员、代理人或代表对用户的全部责任应限于争议交易的买卖金额，参考该交易发生或理应发生时的价格，并在任何情况下均受上限约束。<br><br>

15.5 在任何情况下，BingX 和/或 BingX 的关联方均不对您的任何间接损失承担责任。<br><br>

15.6 本条款中的任何内容均不得限制 BingX 和/或 BingX 的关联方因 BingX 的以下行为而对您承担的责任：<br><br>
...
15.7 本第 15 条中包含的任何排除或限制责任不应限制在相关适用法律法规下不能排除或限制的BingX 的责任。'=>'15.2 To the maximum extent permitted by applicable laws and regulations, BingX assumes all liability for losses that may be caused by or related to the information or materials provided by or on behalf of BingX and its affiliates on the BingX platform. The total value must not exceed $100. <br><br>

15.3 To the maximum extent permitted by applicable laws and regulations, the total value of BingX’s liability for losses arising out of a single claim or a series of claims arising out of:<br><br>
...
(iii) any information or materials provided by or on behalf of BingX and/or its affiliates (other than those referred to in clause 15.3); or<br><br>
...
(b) The total amount of fees paid by User to BingX for the Services during the preceding twelve (12) month period (the "Cap"). <br><br>
...
15.5 Under no circumstances shall BingX and/or BingXs affiliates be liable for any indirect losses to you. <br><br>

15.6 Nothing in these Terms shall limit the liability of BingX and/or BingXs affiliates to you due to BingXs following actions:<br><br>
...
15.7 Any exclusion or limitation of liability contained in this Article 15 shall not limit BingXs liabilities which cannot be excluded or limited under relevant applicable laws and regulations. ',
    ...
    '15.9 在适用法律法规允许的最大范围内，您同意赔偿、保护 BingX 和 BingX 的关联方和联营方（包括我们及其各自的代理人（如有）和BingX 及其关联方和联营方的股东、董事、管理人员和员工（"受偿方"），并立即辩护，并使其免受因各种类型的任何第三方索赔、损失、责任、损害赔偿、判决、处罚、罚款、成本和开支（包括专业费用和合理的律师费）引起或与之相关的任何受偿方可能因以下原因或与之相关而遭受或招致任何及所有损失：<br><br>

(a) 您（或任何用户的授权代表）与帐户或服务相关的使用或行为；<br><br>

(b) 您未能履行您在本条款下的任何义务；<br><br>

(c) 您违约和/或 BingX 执行与违约有关的条款；<br><br>
...
(c) You breach the contract and/or BingX enforces the terms related to the breach;<br><br>
...
(g) In the process of BingX providing services to you in accordance with these Terms, you provide any false, inaccurate, misleading or deceptive information to BingX;<br><br>
...
15.10 If you are obligated to indemnify BingX or any of its affiliates under this Section 15.10, BingX will have the right, in its sole discretion, to control any action or proceeding and to decide whether it wishes to settle and, if so, on what terms it will settle. ',
    ...
    '15.11 BingX 提供的服务和任何信息或材料均基于"原样"和"可用"的基础提供。 BingX 明确排除并且用户放弃任何形式的明示或暗示的任何和所有保证，包括但不限于：<br><br>
...
(a) BingX 未声明或保证服务、用于访问服务的任何界面、网站或 BingX 提供或提供的任何信息或材料是准确的、完整的、可靠的、最新的、无错误的、无病毒或其他有害成分或任何其他缺陷；及<br><br>

(b) BingX 不保证任何订单将被执行、接受、记录或保持开放。<br><br>

15.13 除本条款中规定的明示声明外，您在此确认并同意，对于您使用和访问BingX 平台和/或服务，您未依赖任何其他书面或口头的声明或理解。<br><br>

15.14 您在此理解并同意BingX不对因以下原因引起或与之相关的任何损失承担责任：<br><br>
...
15.15 BingX 无法确保或保证通过电子方式（包括互联网、无线连接、电子邮件、电话和 短信）向 BingX 传输或从BingX 接收的信息的安全性或保密性，因为 BingX 无法确保该等信息的传输信息始终受到保护。如果您有理由相信您的数据不再安全，您应该通过BingX 平台上公布的或不时通知用户的电子邮件地址、邮寄地址或电话号码联系 BingX。'=>'15.11 The services and any information or materials provided by BingX are provided on an "as is" and "as available" basis. BingX EXPRESSLY EXCLUDES AND USER WAIVES ANY AND ALL WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO:<br><br>
...
(a) BingX does not represent or warrant that the Services, any interface used to access the Services, the website, or any information or materials provided or provided by BingX are accurate, complete, reliable, current, error-free, virus-free or otherwise harmful components or any other defects; and<br><br>

(b) BingX does not guarantee that any order will be executed, accepted, recorded or remained open. <br><br>

15.13 Except for the express statements set forth in these Terms, you hereby acknowledge and agree that you have not relied on any other written or oral statements or understandings with respect to your use and access of the BingX platform and/or services. <br><br>

15.14 You hereby understand and agree that BingX shall not be liable for any losses arising out of or related to:<br><br>
...
15.15 BingX cannot ensure or guarantee the security or confidentiality of information transmitted to or received from BingX by electronic means (including the Internet, wireless connections, emails, phone calls and text messages) because BingX cannot ensure that the transmission of such information is always protected. If you have reason to believe that your data is no longer secure, you should contact BingX through the email address, mailing address or phone number published on the BingX platform or notified to users from time to time. ',
    ...
    '16.1 BingX 有权修改、替换、补充或删除（均为"修订"）本条款或本条款的任何部分。<br><br>

16.2 BingX可向用户提供修订通知，透过通过发布修订后的条款并更改条款顶部的“最后更新”日期、通过向用户提供的电子邮件地址发送电子邮件、或通过我们自行决定的任何其他方式。任何修订将在将修订发布到 BingX 平台后或在我们传输信息时立即生效。这些修正案将立即适用于所有当前和后续的使用或服务。<br><br>

16.3 如果用户反对修订，用户的唯一救济措施是停止使用服务并关闭其帐户。 BingX 有权：<br><br>

(a) 根据本条款立即终止与用户之间的本协议；和<br><br>

(b) 暂停用户访问和使用服务。'=>'16.1 BingX reserves the right to modify, replace, supplement or delete (each an "Amendment") these Terms or any part of these Terms. <br><br>
...
16.3 If User objects to an amendment, Users sole remedy is to cease using the Services and close his or her account. BingX is entitled to:<br><br>
...
(b) Suspend the users access to and use of the Service. ',
    ...
    '17.1 如发生将BingX的部分或全部业务转让给任何第三方，用户同意用户与BingX之间的业务关系转移，包括但不限于用户的：<br><br>
...
17.2 如果BingX被第三方主体收购或合并，BingX保留转让或让与从用户处收集的信息作为收购、合并、出售或其他控制权变更的一部分的权利。'=>'17.1 If part or all of BingXs business is transferred to any third party, the user agrees to the transfer of the business relationship between the user and BingX, including but not limited to the users:<br><br>
...
18.4 网站的准确性、完整性和可靠性：除非我们以书面形式明确约定，我们对于用户以任何方式BingX平台所获得的任何内容信息，包括但不限于广告等，不保证其准确性、完整性、可靠性；对于用户因本站上的内容信息而购买、获取的任何产品、服务、信息或资料，我们不承担责任。用户自行承担使用BingX平台信息内容所导致的风险。<br><br>

18.5 用户意见：用户对BingX平台发布的用户评论仅代表用户个人观点。这并不意味着BingX平台同意他们的观点或确认他们的描述。BingX平台不承担任何用户评论引起的任何法律责任。<br><br>
...
(a) "一方"指 BingX 或用户，"各方"指 BingX 和用户；<br><br>
...
(a) "Party" refers to BingX or the User, and "Parties" refers to BingX and the User;<br><br>
...
22.5 Any translations of these Terms or other documents are provided for convenience only and may not accurately reflect the information contained in the original English. In the event of any inconsistency, the English version of these Terms or other documents shall prevail. ',
    ...
    '在 BingX 开立和维护的账户，供用户使用服务以及在 BingX 平台上进行交易，包括反映用户数字资产余额的任何数字资产子账户。在本条款中，“您的账户”是指您的账户和/或您可以控制或访问的任何账户，或如果您是代表、代理人或您拥有类似权限或角色的任何账户。'=>'Accounts opened and maintained on BingX for users to use services and conduct transactions on the BingX platform, including any digital asset sub-accounts that reflect the users digital asset balance. In these Terms, "your account" means your account and/or any account that you have control over or access to, or if you are a representative, agent or any account in which you have similar authority or role. ',
    ...
    '应用程序界面，一种连接功能，允许用户在 BingX 平台上操作其帐户。'=>'Application interface, a connectivity feature that allows users to operate their accounts on the BingX platform. ',

    '适用法律法规'=>'Applicable laws and regulations',

    '适用于在任何相关司法管辖区对 BingX、BingX 平台和/或用户的任何有权机构不时颁布、替换、修订、扩展、合并、替代和/或重新颁布的法律、法规和规则。'=>'Apply to the laws, regulations and rules promulgated, replaced, revised, extended, merged, replaced and/or re-promulgated from time to time by any competent authority in any relevant jurisdiction for BingX, the BingX Platform and/or users. ',

    '申请人'=>'applicant',

    '申请在 BingX 开立账户以在 BingX 平台上进行交易的人。'=>'A person who applies to open an account at BingX to conduct transactions on the BingX platform. ',
    ...
    'BingX 向用户发出的具有约束力的通讯，不时需要通知用户与 BingX 平台的正常运行和用户使用服务相关的具体事项，包括但不限于政策、费用或任何其他变更相关事项。'=>'BingXs binding communications to users are required from time to time to inform users of specific matters related to the normal operation of the BingX platform and users use of services, including but not limited to policies, fees or any other changes related to matters. ',
    ...
    'BingX巴哈马、BingX香港、BingX 巴西、BingX 新加坡或Aux Cayes (视情况适用于各自的用户)。'=>'BingX Bahamas, BingX Hong Kong, BingX Brazil, BingX Singapore or Aux Cayes (as applicable to the respective user). ',

    'BingX 平台'=>'BingX PLATFORM',

    '通过 [Bingx-hg.com](http://Bingx-hg.com/)、API 或 BingX 运营的移动应用程序访问在线平台。'=>'Access the online platform through [Bingx-hg.com](http://Bingx-hg.com/), API or mobile applications operated by BingX. ',
    ...
    'BingX 的关联公司、子公司、姊妹公司、联营公司及/或相关公司。'=>'BingXs affiliates, subsidiaries, sister companies, associated companies and/or related companies. ',

    '限制地区'=>'Restricted areas',

    '如第 2.2 条所述，BingX 不提供或仅提供有限服务的地点，BingX 可能会不时更新地区名单。'=>'As stated in Section 2.2, BingX may update the list of locations where BingX does not provide or only provides limited services from time to time. ',

    '风险声明'=>'Risk Statement',

    'BingX就第6条规定的BingX平台交易风险向用户作出的声明'=>'BingXs statement to users regarding the risks of trading on the BingX platform stipulated in Article 6',

    '服务'=>'Serve',

    'BingX 根据本条款向用户提供的服务，包括在 BingX 平台上的交易和用户数字资产的托管。'=>'The services provided by BingX to users in accordance with these Terms include transactions on the BingX platform and custody of user digital assets. ',

    '现货服务'=>'Ready stock',

    'BingX提供的通过 (a) C2C（点对点）或(b)集中交易平台进行的数字资产的现货交易。'=>'BingX provides spot trading of digital assets via (a) C2C (peer-to-peer) or (b) centralized trading platform. ',
    ...
    'BingX 平台上由两个订单执行产生的交易'=>'A transaction resulting from the execution of two orders on the BingX platform',

    '用户'=>'user',

    '使用 BingX 平台、BingX 根据本条款向其提供服务并同意本条款的自然人或法人实体（例如企业或机构客户）。 为避免疑义，用户可以包括从事第 4.6 条所述交易活动的关联方。'=>'A natural person or legal entity (such as a business or institutional client) who uses the BingX platform, to whom BingX provides services in accordance with these Terms, and who agrees to these Terms. For the avoidance of doubt, Users may include related parties engaged in the trading activities described in Section 4.6. ',
    ...
    '空投'=>'Airborne',
    "BingX（Bingx-hg.com）是全球著名的数字资产交易平台之一，主要面向全球用户提供比特币、莱特币、<br>以太币等数字资产的币币和衍生品交易服务。"=>"BingX (Bingx-hg.com) is one of the world's famous digital asset trading platforms. It mainly provides currency and derivatives trading services for digital assets such as Bitcoin, Litecoin, and Ethereum to global users.",
    "愿景"=>"Vision",
