	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b">
	                       <a data-bn-type="link" href="<?php echo U('User/index');?>" class="css-z87e9z" style="text-decoration: none;">
	                           <div class="css-10j588g">
	                               <i class="bi bi-person-fill css-14thuu2"></i>
	                       ...
	                       <a data-bn-type="link" href="<?php echo U('User/notice');?>" class="css-6ijtmk"  style="text-decoration: none;">
	                           <div class="css-10j588g">
	                   ...
	                   <div class="css-160vccy">
	                       ...
	                       <div class="css-jlbk6n">
	                                    ...
	                                    <div class="css-1hythwr">
	                                        <div class="css-1hz1mz6">
	                                            <div class="css-5x6ly7">
	                                                <div class="css-5x6ly7">
	                                                    <a style="background-color: transparent;" data-bn-type="link"  id="balance" class="css-181kvgz">USDT<?php echo L('账户余额详情');?></a>
	                                                </div>
	                                                        ...
	                                                        <div class="css-1bliacb">
	                                                            <div class="css-vurnku">
	                                                                <div class="css-1f978ju">
	                                                                    <div class="css-ize0sl">
	                                                                        <span data-bn-type="text" dir="ltr" class="css-1kbdyxh">USDT<?php echo L('账户余额');?> 
	                                                                        <a href="" style="color:rgb(240, 185, 11);">(<?php echo L('前往钱包查看资产总余额');?>)</a>
	                                                                        </span>
	                                                                    </div>
	                                                                    <div class="css-n5mzgu">
	                                                                        <div dir="ltr" class="css-off8uh">
	                                                                            <div data-bn-type="text" class="css-1t9tl2o"><?php echo ($balance); ?></div>
	                                                                            <div style="width: 4px;"></div>
	                                                                            <div data-bn-type="text" class="css-vurnku">USDT</div>
	                                                                        </div>
	                                                                     </div>
	                                                                </div>
	                                                            </div>
	                           ...
	                           <div class="css-omwf4y">
	                               <div class="css-vt77s9">
	                                   <div class="css-1hythwr">
	                                       <div class="css-hwv82q">
	                                           <div class="css-5x6ly7">
	                                               <div class="css-5x6ly7">
	                                                   <a  href="<?php echo U('Index/gglist');?>"  class="css-181kvgz"><?php echo L('公告中心');?></a>
	                                               </div>
	                                               <div class="css-10nf7hq">
	                                                   <a  href="<?php echo U('Index/gglist');?>"  class="css-1s6nhe2">
	                                                       <i class="bi bi-chevron-right css-155meta"></i>
	                                                   </a>
	                                               </div>
	                                           </div>
	                                       </div>
	                                       <div class="css-65w75">
	                                           <?php if(is_array($notice)): foreach($notice as $key=>$vo): ?><a href="<?php echo U('Index/gginfo');?>?id=<?php echo ($vo["id"]); ?>" class="css-1wuyyej">
	                                               <div class="LinesEllipsis  "><?php echo ($vo["title"]); ?><wbr></div>
	                                               <div data-bn-type="text" class="css-1joqi3u"><?php echo ($vo["addtime"]); ?></div>
	                               ...
	                               <div class="css-1p01izn">
	                                   <div class="css-1hythwr">
	                                       <div class="css-hwv82q">
	                                           <div class="css-5x6ly7">
	                                               <div class="css-5x6ly7">
	                                                   <a href="<?php echo U('Trade/bborder');?>" class="css-181kvgz"><?php echo L('币币交易委托');?></a>
	                                               </div>
	                                               <div class="css-10nf7hq">
	                                                   <a href="<?php echo U('Trade/bborder');?>" class="css-1s6nhe2">
	                                                       <i class="bi bi-chevron-right css-155meta"></i>
	                                                   </a>
	                                               </div>
	                                           </div>
	                                       ...
	                                       <div class="css-1dcd6pv">
	                                           <div class="css-1h690ep">
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('交易对');?></div>
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('时间');?></div>
	                                               </div>
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('类型');?> / <?php echo L('方向');?></div>
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('触发条件');?></div>
	                                               </div>
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('限价价格');?></div>
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('数量');?></div>
	                                               </div>
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('成交额');?></div>
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('完成度');?></div>
	                                               </div>
	                                               <div class="css-1ngrbny">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('操作');?></div>
	                                               </div>
	                                           </div>
	                                           <?php if(is_array($bblist)): foreach($bblist as $key=>$vo): ?><div class="css-1pysja1">
	                                               <div class="css-kc3i4p">
	                                                   <div class="css-phax11">
	                                                       <div data-bn-type="text" class="css-1g02g2m"><?php echo ($vo["symbol"]); ?></div>
	                                                       <div data-bn-type="text" class="css-cvky42"><?php echo ($vo["addtime"]); ?></div>
	                                                   </div>
	                                                   <div class="css-phax11">
	                                                       <div class="css-4cffwv">
	                                                           <div data-bn-type="text" class="css-cvky42"><?php echo L('限价');?> / </div>
	                                                           <div data-bn-type="text" class="css-1pryf6p">
	                                                               <?php if($vo["type"] == 1): ?><span class="bgreen"><?php echo L('购买');?></span>
	                                                               <?php elseif($vo["type"] == 2): ?>
	                                                               <span class="bred"><?php echo L('出售');?></span><?php endif; ?>
	                                                           </div>
	                                                       </div>
	                                                       <div data-bn-type="text" class="css-cvky42">_</div>
	                                                   </div>
	                                                       <div class="css-phax11">
	                                                           <?php if($vo["type"] == 1): ?><div data-bn-type="text" class="css-1g02g2m"><?php echo ($vo["xjprice"]); ?></div> 
	                                                           <div data-bn-type="text" class="css-cvky42"><?php echo ($vo["coinnum"]); ?></div>
	                                                           <?php elseif($vo["type"] == 2): ?>
	                                                           <div data-bn-type="text" class="css-1g02g2m"><?php echo ($vo["xjprice"]); ?></div> 
	                                                           <div data-bn-type="text" class="css-cvky42"><?php echo ($vo["usdtnum"]); ?></div><?php endif; ?>
	                                                           
	                                                           
	                                                       </div>
	                                                       <div class="css-phax11">
	                                                           <?php if($vo["type"] == 1): ?><div data-bn-type="text" class="css-1g02g2m"><?php echo ($vo["usdtnum"]); ?></div> 
	                                                           <div data-bn-type="text" class="css-cvky42">0.00%</div>
	                                                           <?php elseif($vo["type"] == 2): ?>
	                                                           <div data-bn-type="text" class="css-1g02g2m"><?php echo ($vo["coinnum"]); ?></div> 
	                                                           <div data-bn-type="text" class="css-cvky42">0.00%</div><?php endif; ?>

	                                                       </div>
	                                                       <div class="css-1ngrbny">
	                                                           <div  onclick="clearorder(<?php echo ($vo["id"]); ?>);" data-bn-type="text" class="css-9biujf"><?php echo L('取消');?></div>
	                                                       </div>
	                                               </div>
	                               ...
	                               <div class="css-1p01izn">
	                                   <div class="css-1hythwr">
	                                       <div class="css-hwv82q">
	                                           <div class="css-5x6ly7">
	                                               <div class="css-5x6ly7">
	                                                   <a href="<?php echo U('Contract/contractjc');?>" class="css-181kvgz"><?php echo L('秒合约委托');?></a>
	                                               </div>
	                                               <div class="css-10nf7hq">
	                                                   <a href="<?php echo U('Contract/contractjc');?>" class="css-1s6nhe2">
	                                                       <i class="bi bi-chevron-right css-155meta"></i>
	                                                   </a>
	                                               </div>
	                                           </div>
	                                       ...
	                                       <div class="css-1dcd6pv">
	                                           <div class="css-1h690ep">
	                                               <div class="css-phax11" style="width:25%;">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('交易对');?></div>
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('建仓时间');?></div>
	                                               </div>
	                                               <div class="css-phax11" style="width:25%;">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('类型');?> / <?php echo L('方向');?></div>
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('触发条件');?></div>
	                                               ...
	                                               <div class="css-phax11" style="width:25%;">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('建仓单价');?></div>
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('建仓金额');?></div>
	                                               </div>
	                                               <div class="css-phax11" style="width:25%;">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('时间');?></div>
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('完成度');?></div>
	                                           ...
	                                           <?php if(is_array($hylist)): foreach($hylist as $key=>$hyv): ?><div class="css-1pysja1">
	                                               <div class="css-kc3i4p">
	                                                   <div class="css-phax11" style="width:25%;">
	                                                       <div data-bn-type="text" class="css-1g02g2m"><?php echo ($hyv["coinname"]); ?></div>
	                                                       <div data-bn-type="text" class="css-cvky42"><?php echo ($hyv["buytime"]); ?></div>
	                                                   </div>
	                                                   <div class="css-phax11" style="width:25%;">
	                                                       <div class="css-4cffwv">
	                                                           <div data-bn-type="text" class="css-cvky42"><?php echo L('周期');?> / </div>
	                                                           <div data-bn-type="text" class="css-1pryf6p"><?php echo L('购买');?></div>
	                                                       </div>
	                                                       <div data-bn-type="text" class="css-cvky42">_</div>
	                                                   </div>
	                                                   <div class="css-phax11" style="width:25%;">
	                                                       <div data-bn-type="text" class="css-1g02g2m"><?php echo ($hyv["buyprice"]); ?></div>
	                                                       <div data-bn-type="text" class="css-cvky42"><?php echo ($hyv["num"]); ?></div>
	                                                   </div>
	                                                   <div class="css-phax11" style="width:25%;">
	                                                       <div data-bn-type="text" class="css-1g02g2m"><?php echo ($hyv["time"]); echo L('分钟');?></div>
	                                                       <div data-bn-type="text" class="css-cvky42">0.00%</div>
	                                                   </div>
	                                               </div>
	                                           </div><?php endforeach; endif; ?>
