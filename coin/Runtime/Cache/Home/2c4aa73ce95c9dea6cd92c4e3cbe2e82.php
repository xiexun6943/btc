	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b">
	                       ...
	                       <a data-bn-type="link" href="<?php echo U('User/mybill');?>" class="css-z87e9z"  style="text-decoration: none;">
	                           <div class="css-10j588g">
	                               <i class="bi bi-card-list css-14thuu2"></i>
	                                   ...
	                                   <div class="css-1hythwr">
	                                       <div class="css-hwv82q">
	                                           <div class="css-5x6ly7">
	                                               <div class="css-5x6ly7">
	                                                   <a class="css-181kvgz"><?php echo L('财务记录');?></a>
	                                               </div>
	                                               <!--这里可以加搜索框-->
	                                       ...
	                                       <div class="css-1dcd6pv">
	                                           <div class="css-1h690ep">
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('操作类型');?></div>
	                                               </div>
	                                               <div class="css-phax11" style="width:30%">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('币种');?></div>
	                                               </div>
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('数量');?></div>
	                                               </div>
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('操作后余额');?></div>
	                                               </div>
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('操作日期');?></div>
	                                               </div>
	                                           </div>
	                                           
	                                           
	                                           <div class="css-1pysja1"  id="tradebox">
	                                               <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="css-kc3i4p">
	                                                   <div class="css-phax11">
	                                                       <div data-bn-type="text" class="css-1g02g2m" style="font-sie:12px;">
		                                                        <span class="fch fzmm"><?php echo L('认购币释放');?></span>
	                                                       </div>
	                                                   </div>
	                                                   <div class="css-phax11" style="width:30%">
	                                                       <div class="css-4cffwv">
	                                                           <div data-bn-type="text" class="css-cvky42"><?php echo strtoupper($vo['coinname']);?></div>
	                                                       </div>
	                                                   </div>
	                                                   <div class="css-phax11">
	                                                       <div class="css-4cffwv">
	                                                           <div data-bn-type="text" class="css-cvky42"><?php echo ($vo["num"]); ?></div>
	                                                       </div>
	                                                   </div>
	                                                   
	                                                   <div class="css-phax11">
	                                                       <div class="css-4cffwv">
	                                                           <?php if($vo["st"] == 1): ?><div data-bn-type="text" class="css-cvky42" style="color:green;">+<?php echo ($vo["afternum"]); ?></div>
	                                                           <?php elseif($vo["st"] == 2): ?>
	                                                           <div data-bn-type="text" class="css-cvky42" style="color:red;">-<?php echo ($vo["afternum"]); ?></div><?php endif; ?>
	                                                       </div>
	                                                   </div>
	                                                   <div class="css-phax11">
	                                                       <div class="css-4cffwv">
...
<script>
    ...
    <!--<script type="text/javascript">
        function getbill(){
            $.post("<?php echo U('User/getbilllist');?>",
            function(data){
                if(data.code == 1){
                    $("#tradebox").empty();
                    var html = '';
                    if(data.data == '' || data.data == null){
                        ...
                        $.each(data.data,function(key,val){
                            html += '<div class="css-kc3i4p">'+
	                                '<div class="css-phax11">'+
	                                '<div data-bn-type="text" class="css-1g02g2m" style="font-sie:12px;">'+
		                            '<span class="fch fzmm">认购币释放</span>'+
	                                '</div>'+
	                                '</div>'+
	                                '<div class="css-phax11" style="width:30%">'+
	                                '<div class="css-4cffwv">'+
	                                '<div data-bn-type="text" class="css-cvky42">币名</div>'+
	                                '</div>'+
	                                '</div>'+
	                                '<div class="css-phax11">'+
	                                '<div class="css-4cffwv">'+
	                                '<div data-bn-type="text" class="css-cvky42">+100</div>'+
	                                '</div>'+
	                                '</div>'+
	                                '<div class="css-phax11">'+
	                                '<div class="css-4cffwv">'+
	                                '<div data-bn-type="text" class="css-cvky42" style="color:green;">100</div>'+
	                                '</div>'+
	                                '</div>'+
	                                '<div class="css-phax11">'+
	                                '<div class="css-4cffwv">'+
	                                '<div data-bn-type="text" class="css-cvky42">2021-09-27 22:46:25</div>'+
	                                '</div>'+
	                                '</div>'+
	                                '</div>';
                        });
