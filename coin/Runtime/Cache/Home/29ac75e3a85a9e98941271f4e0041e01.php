...
<html lang="zh-CN">
    <head>
        ...
        <style>
            ...
            .titleop{height:40px;line-height:40px;text-align:left;float:left;padding-left:15px;overflow:hidden;}
            .coincontent{width:100%;height:50px;background-color:#fff;border-bottom:1px solid #f5f5f5;}
            .contentop{height:50px;line-height:50px;text-align:left;float:left;padding-left:15px;overflow:hidden;}
	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b">
	                       ...
	                       <a data-bn-type="link" href="<?php echo U('Finance/txlist');?>" class="css-z87e9z"  style="text-decoration: none;">
	                           <div class="css-10j588g">
                                ...
                                <div class="css-1lu4p3l">
                                    ...
                                    <div class="css-9cxewd">
                                        <div class="css-1inwbdu">
                                            <a  class="css-9wsvyu"><?php echo L('提币列表');?></a>
                                        </div>
                                        <div class="css-1ammkwy">
                                            <div class="coinbox">
                                                <div class="cointitle">
                                                    <div class="titleop" style="width:10%;">
                                                        <span class="f14 fch"><?php echo L('提币币种');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:10%;">
                                                        <span class="f14 fch"><?php echo L('提币额度');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:10%;">
                                                        <span class="f14 fch"><?php echo L('手续费');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:10%;">
                                                        <span class="f14 fch"><?php echo L('实际到账');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:40%;">
                                                        <span class="f14 fch"><?php echo L('提币地址');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:10%;">
                                                        <span class="f14 fch"><?php echo L('提币时间');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:10%;">
                                                ...
                                                <?php if(is_array($txlist)): foreach($txlist as $key=>$vo): ?><div class="coincontent">
                                                    <div class="contentop" style="width:5%;">
                                                        <span class="f14 fch"><?php echo strtoupper($vo['coinname']);?></span>
                                                    </div>
                                                    <div class="contentop" style="width:10%;">
                                                        <span class="f14 fch"><?php echo ($vo["num"]); ?></span>
                                                    </div>
                                                    <div class="contentop" style="width:10%;">
                                                        <span class="f14 fch"><?php echo ($vo["fee"]); ?></span>
                                                    </div>
                                                    <div class="contentop" style="width:10%;">
                                                        <span class="f14 fch"><?php echo ($vo["mum"]); ?></span>
                                                    </div>
                                                    <div class="contentop" style="width:40%;">
                                                        <span class="f14 fch"><?php echo ($vo["address"]); ?></span>
                                                    </div>
                                                    <div class="contentop" style="width:15%;">
                                                        <span class="f14 fch"><?php echo ($vo["addtime"]); ?></span>
                                                    </div>
                                                    <div class="contentop" style="width:8%;">
                                                        <?php if($vo['status']==1){?>
                                                        <span class="f14 fch fw"><?php echo L('确认中');?></span>
                                                        <?php }elseif($vo['status']==2){?>
                                                        <span class="f14 bgreen fw"><?php echo L('完成');?></span>
                                                        <?php }elseif($vo['status']==3){?>
                                                        <span class="f14 bred fw"><?php echo L('原路返回');?></span>
                                                        <?php }?>
                                                    </div>
