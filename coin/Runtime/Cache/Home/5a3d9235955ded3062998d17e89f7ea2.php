	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b">
	                       ...
	                       <a data-bn-type="link" href="<?php echo U('User/authrz');?>" class="css-z87e9z"  style="text-decoration: none;">
	                           <div class="css-10j588g">
	                    ...
	                    <div class="css-1wr4jig">
	                        <div class="css-1u0m1fa">
                                <div class="css-fhl5lc">
                                    <a class="css-1cdfkn6" href="##"><?php echo L('实名认证管理');?></a>
                                </div>
                            </div>
                            ...
                            <div class="css-1bbywci">
                                <div class="css-1pl31wt">
                                    <div class="css-k2y2sp">
                                        <div data-bn-type="text" class="css-1868gi1"><?php echo L('认证信息');?></div>
                                ...
                                <div class="css-z32tht">
                                    <div class="css-joa6mv">
                                        <span class="f12 fcy"><?php echo L('完成实名认证后能够获得相应的权益');?></span>
                                    </div>
                                        ...
                                        <div style="width:400px;min-height: 400px;">
                                            <div class="css-vurnku">
	                                            <div class="css-154a57d">
	                                                <input data-bn-type="input" id="phone" placeholder="<?php echo L('请输入手机号码');?>" class="css-16fg16t" value="<?php echo ($info["phone"]); ?>">
	                                                <label class="bn-input-label css-5vzups">
	                                                    <div data-bn-type="text" class="css-kiaw5d"><?php echo L('手机号码');?></div>
	                                                </label>
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="css-vurnku">
	                                            <div class="css-154a57d" style="border:none;min-height:120px;max-height:200px;">
	                                                ...
	                                                <?php }?>
	                                                <label class="bn-input-label css-5vzups">
	                                                    <div data-bn-type="text" class="css-kiaw5d"><?php echo L('上传身份证正面');?></div>
	                                                </label>
	                                            </div>
	                                        </div>
	                                        <div style="width:100%;height:30px;"></div>
	                                        <div class="css-vurnku">
	                                            <div class="css-154a57d" style="border:none;min-height:120px;max-height:200px;">
	                                                ...
	                                                <?php }?>
	                                                <label class="bn-input-label css-5vzups">
	                                                    <div data-bn-type="text" class="css-kiaw5d"><?php echo L('上传身份证背面');?></div>
	                                                </label>
	                                            </div>
	                                        </div>
	                                        <input type="hidden" id="flag" value="1" />
	                                        <div style="width:100%;height:30px;"></div>
	                                        <?php if($info["rzstatus"] == 2): ?><div class="css-x5jwjg">
                                            <button data-bn-type="button"  class="css-3kuzxc" style="padding: 6px 30px;"><?php echo L('认证审核成功');?></button>
                                            </div>
	                                        <?php else: ?>
	                                        <div class="css-x5jwjg">
                                                <button data-bn-type="button" id="sumbtn"  class="css-3kuzxc" style="padding: 6px 30px;"><?php echo L('提交');?></button>
                                            </div><?php endif; ?>
                                        </div>
                                    </div>
                                </div>
