	        ...
	        <div class="order_navlist" style="min-width:160px;top:50px;right: 10px;">
	            ...
	            <main class="css-1wr4jig" style="background: #fff;">
                    ...
                    <div class="css-uliqdc">
                        <div style="width:100%;min-height:500px;background:#f5f5f5;padding:20px 50px;">
                            ...
                            <?php if(empty($list)): ?><div style="width:100%;height:400px;line-height:400px;text-align:center;">
	                         ...
	                         <?php else: ?>
                            <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div style="width:100%;height:290px;background:#fff;margin-bottom:20px;box-shadow: 0 2px 10px 0 rgb(0 0 0 / 10%);border-radius:5px;">
                                            ...
                                            <div style="width:100%;height:230px;">
                                                ...
                                                <div style="width:75%;padding:10px 0px 10px 10px;float:right;">
                                                    <div style="width:100%;min-height:30px;">
                                                        <span class="f16 fch"><?php echo ($vo["name"]); ?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('认购币种');?>：<?php echo strtoupper($vo['coinname']);?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('开始时间');?>：<?php echo ($vo["starttime"]); ?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('结束时间');?>：<?php echo strtoupper($vo['finishtime']);?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('发行总量');?>：<?php echo ($vo["num"]); ?> <?php echo strtoupper($vo['coinname']);?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('参与数量');?>：<?php echo ($vo["ysnum"]); ?> <?php echo strtoupper($vo['coinname']);?></span>
                                                    </div>
                                                </div>
                                    ...
                                    <div style="width:50%;height:240px;float:left;padding:5px;">
                                        <div style="width:100%;height:240px;">
                                            <div style="width:100%;height:240px;padding:10px 0px 10px 10px;">
                                                ...
                                                <div style="width:100%;height:30px;">
                                                    <span class="f14 fcc"><?php echo L('认购上限');?> ：<?php echo ($vo["allmax"]); ?></span>
                                                </div>
                                                <div style="width:100%;height:30px;">
                                                    <span class="f14 fcc"><?php echo L('单次最低');?> ：<?php echo ($vo["min"]); ?></span>
                                                </div>
                                                <div style="width:100%;height:30px;">
                                                    <span class="f14 fcc"><?php echo L('认购单价');?> ：<?php echo ($vo["price"]); ?></span>
                                                </div>
...
<!--					                    </div>-->
                                    ...
                                    <div style="width:20%;height:40px;float:left;">
                                        <div style="width:100%;height:40px;text-align:center;">
                                            <a href="<?php echo U('Issue/details');?>?id=<?php echo ($vo["id"]); ?>" class="css-bhso1m" style="padding:5px 15px;	        "><?php echo L('立即参与');?></a>
                                        </div>
                                    </div>
                                </div>
