	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b">
	                       ...
	                       <a data-bn-type="link" href="<?php echo U('Orepool/profitlist');?>" class="css-z87e9z"  style="text-decoration: none;">
	                           <div class="css-10j588g">
                                ...
                                <div class="css-1lu4p3l">
                                    <div class="css-b80wxf">
                                        <div class="css-1s8q8od">
                                            <div data-bn-type="text" class="css-u95vxr"><?php echo L('矿机收益记录');?></div>
                                        </div>
                                    ...
                                    <div class="css-9cxewd">
                                        <div class="css-1inwbdu">
                                            <a  class="css-9wsvyu"><?php echo L('矿机收益记录');?></a>
                                        </div>
                                        <div class="css-1ammkwy">
                                            <div class="coinbox">
                                                <div class="cointitle">
                                                    <div class="titleop" style="width:40%;">
                                                        <span class="f14 fch"><?php echo L('矿机名称');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:15%;">
                                                        <span class="f14 fch"><?php echo L('收益币种');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:15%;">
                                                        <span class="f14 fch"><?php echo L('收益金额');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:15%;">
                                                        <span class="f14 fch"><?php echo L('收益日期');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:15%;">
                                                        <span class="f14 fch"><?php echo L('释放状态');?></span>
                                                    </div>
                                                ...
                                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="coincontent">
                                                    <div class="contentop" style="width:40%;">
                                                        <span class="f14 fch"><?php echo ($vo["ktitle"]); ?></span>
                                                    </div>
                                                    <div class="contentop" style="width:15%;">
                                                        <span class="f14 fch"><?php echo strtoupper($vo['coin']);?></span>
                                                    </div>
                                                    <div class="contentop" style="width:15%;">
                                                    ...
                                                    <div class="contentop" style="width:15%;">
                                                        <?php if($vo["status"] == 1): ?><span class="f14 fgreen fw"><?php echo L('已释放');?></span>
                                                        <?php elseif($vo["status"] == 2): ?>
                                                        <span class="f14 fred fw"><?php echo L('未释放');?></span><?php endif; ?>
                                                    </div>
