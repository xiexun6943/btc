	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b">
	                       ...
	                       <a data-bn-type="link" href="<?php echo U('User/tgcode');?>" class="css-z87e9z"  style="text-decoration: none;">
	                           <div class="css-10j588g">
	                               <i class="bi bi-person-plus css-14thuu2"></i>
	                                    ...
	                                    <div class="css-1hythwr">
	                                        <div class="css-1hz1mz6">
	                                            <div class="css-5x6ly7">
	                                                <div class="css-5x6ly7">
	                                                    <a style="background-color: transparent;"  id="balance" class="css-181kvgz"><?php echo L('团队详情');?></a>
	                                                </div>
	                                            ...
	                                            <div class="css-gnqbje">
	                                                <div class="css-ysetcg">
	                                                    <div class="css-ct0qa6">
	                                                        <div class="css-1bliacb" style="float:left;">
	                                                            <div class="css-vurnku">
	                                                                <div class="css-1f978ju">
	                                                                    <div class="css-ize0sl">
	                                                                        <span data-bn-type="text" dir="ltr" class="css-1kbdyxh"><?php echo L('三代会员统计');?>: </span>
	                                                                    </div>
	                                                                    <div class="css-n5mzgu">
	                                                                        <div dir="ltr" class="css-off8uh">
	                                                                            <div data-bn-type="text" class="css-1t9tl2o"><?php echo ($carr["allrz"]); ?></div>
	                                                                            <div style="width: 4px;"></div>
	                                                                            <div data-bn-type="text" class="css-vurnku"><?php echo L('人');?>&nbsp;&nbsp;<?php echo L('已认证');?></div>
	                                                                        </div>
	                                                                     </div>
	                                                                     <div class="css-n5mzgu">
	                                                                        <div dir="ltr" class="css-off8uh">
	                                                                            <div data-bn-type="text" class="css-1t9tl2o"><?php echo ($carr["allnrz"]); ?></div>
	                                                                            <div style="width: 4px;"></div>
	                                                                            <div data-bn-type="text" class="css-vurnku"><?php echo L('人');?>&nbsp;&nbsp;<?php echo L('未认证');?></div>
	                                                                        </div>
	                                                                     </div>
	                                                                </div>
	                                                            </div>
	                                                        ...
	                                                        <div class="css-1bliacb" style="float:left;">
	                                                            <div class="css-vurnku">
	                                                                <div class="css-1f978ju">
	                                                                    <div class="css-ize0sl">
	                                                                        <span data-bn-type="text" dir="ltr" class="css-1kbdyxh"><?php echo L('一代会员');?>: </span>
	                                                                    </div>
	                                                                    <div class="css-n5mzgu">
	                                                                        <div dir="ltr" class="css-off8uh">
	                                                                            <div data-bn-type="text" class="css-1t9tl2o"><?php echo ($carr["one"]); ?></div>
	                                                                            <div style="width: 4px;"></div>
	                                                                            <div data-bn-type="text" class="css-vurnku"><?php echo L('人');?>&nbsp;&nbsp;<?php echo L('已认证');?></div>
	                                                                        </div>
	                                                                     </div>
	                                                                     <div class="css-n5mzgu">
	                                                                        <div dir="ltr" class="css-off8uh">
	                                                                            <div data-bn-type="text" class="css-1t9tl2o"><?php echo ($carr["onen"]); ?></div>
	                                                                            <div style="width: 4px;"></div>
	                                                                            <div data-bn-type="text" class="css-vurnku"><?php echo L('人');?>&nbsp;&nbsp;<?php echo L('未认证');?></div>
	                                                                        </div>
	                                                                     </div>
	                                                        ...
	                                                        <div class="css-1bliacb" style="float:left;">
	                                                            <div class="css-vurnku">
	                                                                <div class="css-1f978ju">
	                                                                    <div class="css-ize0sl">
	                                                                        <span data-bn-type="text" dir="ltr" class="css-1kbdyxh"><?php echo L('二代会员');?>: </span>
	                                                                    </div>
	                                                                    <div class="css-n5mzgu">
	                                                                        <div dir="ltr" class="css-off8uh">
	                                                                            <div data-bn-type="text" class="css-1t9tl2o"><?php echo ($carr["two"]); ?></div>
	                                                                            <div style="width: 4px;"></div>
	                                                                            <div data-bn-type="text" class="css-vurnku"><?php echo L('人');?>&nbsp;&nbsp;<?php echo L('已认证');?></div>
	                                                                        </div>
	                                                                     </div>
	                                                                     <div class="css-n5mzgu">
	                                                                        <div dir="ltr" class="css-off8uh">
	                                                                            <div data-bn-type="text" class="css-1t9tl2o"><?php echo ($carr["twon"]); ?></div>
	                                                                            <div style="width: 4px;"></div>
	                                                                            <div data-bn-type="text" class="css-vurnku"><?php echo L('人');?>&nbsp;&nbsp;<?php echo L('未认证');?></div>
	                                                                        </div>
	                                                                     </div>
	                                                        ...
	                                                        <div class="css-1bliacb" style="float:left;">
	                                                            <div class="css-vurnku">
	                                                                <div class="css-1f978ju">
	                                                                    <div class="css-ize0sl">
	                                                                        <span data-bn-type="text" dir="ltr" class="css-1kbdyxh"><?php echo L('三代会员');?>: </span>
	                                                                    </div>
	                                                                    <div class="css-n5mzgu">
	                                                                        <div dir="ltr" class="css-off8uh">
	                                                                            <div data-bn-type="text" class="css-1t9tl2o"><?php echo ($carr["three"]); ?></div>
	                                                                            <div style="width: 4px;"></div>
	                                                                            <div data-bn-type="text" class="css-vurnku"><?php echo L('人');?>&nbsp;&nbsp;<?php echo L('已认证');?></div>
	                                                                        </div>
	                                                                     </div>
	                                                                     <div class="css-n5mzgu">
	                                                                        <div dir="ltr" class="css-off8uh">
	                                                                            <div data-bn-type="text" class="css-1t9tl2o"><?php echo ($carr["threen"]); ?></div>
	                                                                            <div style="width: 4px;"></div>
	                                                                            <div data-bn-type="text" class="css-vurnku"><?php echo L('人');?>&nbsp;&nbsp;<?php echo L('未认证');?></div>
	                                                                        </div>
	                                                                     </div>
	                               ...
	                               <div class="css-vt77s9">
	                                   <div class="css-1hythwr">
	                                       <div class="css-hwv82q">
	                                           <div class="css-5x6ly7">
	                                               <div class="css-5x6ly7">
	                                                   <a class="css-181kvgz"><?php echo L('推荐码');?></a>
	                                               </div>
	                                               <div class="css-10nf7hq">
	                                                   <a class="css-1s6nhe2">
	                                       ...
	                                       <div class="css-65w75">
	                                          ...
	                                          <div class="LinesEllipsis  ">
	                                              <img src="/Public/Static/qrcode/<?php echo ($invit); ?>.png" style="width:120px;">
	                                          </div>
                                                   <input type="hidden" value="<?php echo ($url); ?>" id="qrcode_url">
	                                               <div class="LinesEllipsis  "><?php echo L('我的邀请码');?>：<?php echo ($invit); ?><wbr></div>
	                                               <div class="css-1joqi3u" onclick="copyUrl()" style="cursor:pointer;color:rgb(240, 185, 11);"><?php echo L('复制邀请链接');?></div>
	                                           </a>
	                                       </div>
	                                   </div>
	                               </div>
	                               ...
	                               <div class="css-1p01izn">
	                                   <div class="css-1hythwr">
	                                       <div class="css-hwv82q">
	                                           <div class="css-5x6ly7">
	                                               <div class="css-5x6ly7">
	                                                   <a href="##" class="css-181kvgz"><?php echo L('登陆日志');?></a>
	                                               </div>
	                                       ...
	                                       <div class="css-1dcd6pv">
	                                           <div class="css-1h690ep">
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('登陆类型');?></div>
	                                               </div>
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('登陆IP');?></div>
	                                               </div>
	                                               <div class="css-phax11">
	                                                   <div data-bn-type="text" class="css-9b6x94"><?php echo L('登陆时间');?></div>
	                                               </div>
	                                           </div>
	                                           
	                                           <?php if(is_array($loglist)): foreach($loglist as $key=>$vo): ?><div class="css-1pysja1">
	                                               <div class="css-kc3i4p">
	                                                   <div class="css-phax11">
	                                                       <div data-bn-type="text" class="css-1g02g2m"><?php echo ($vo["remark"]); ?></div>
	                                                   </div>
	                                                   <div class="css-phax11">
	                                                       <div class="css-4cffwv">
	                                                           <div data-bn-type="text" class="css-cvky42"><?php echo ($vo["addip"]); ?></div>
	                                                       </div>
	                                                   </div>
	                                                   <div class="css-phax11">
	                                                       <div data-bn-type="text" class="css-1g02g2m"><?php echo date("Y-m-d H:i:s",$vo['addtime']);?></div>
	                                                   </div>
	                                               </div>
