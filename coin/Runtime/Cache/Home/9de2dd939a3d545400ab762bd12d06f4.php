	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b">
	                       ...
	                       <a data-bn-type="link" href="<?php echo U('User/respwd');?>" class="css-z87e9z"  style="text-decoration: none;">
	                           <div class="css-10j588g">
	                               <i class="bi bi-gear css-14thuu2"></i>
	                    ...
	                    <div class="css-1wr4jig">
	                        <div class="css-1u0m1fa">
                                <div class="css-fhl5lc">
                                    <a class="css-1cdfkn6" href="##"><?php echo L('修改密码');?></a>
                                </div>
                            </div>
                            ...
                            <div class="css-1bbywci">
                                <div class="css-1pl31wt">
                                    <div class="css-k2y2sp">
                                        <div data-bn-type="text" class="css-1868gi1"><?php echo L('修改登陆密码');?></div>
                                ...
                                <div class="css-z32tht">
                                    <div class="css-joa6mv">
                                        <span class="f12 fcy">*<?php echo L('为了您的资金安全，登陆密码修改后24小时以内不允许提现');?></span>
                                    </div>
                                        ...
                                        <div style="width:400px;min-height: 400px;">
                                            <div class="css-vurnku">
	                                            <div class="css-154a57d">
	                                                <input type="password" id="oldpwd" placeholder="<?php echo L('请输入旧密码');?>" class="css-16fg16t" value="">
	                                                <label class="bn-input-label css-5vzups">
	                                                    <div data-bn-type="text" class="css-kiaw5d"><?php echo L('旧密码');?></div>
	                                                </label>
	                                            </div>
	                                        </div>
                                            ...
                                            <div class="css-vurnku">
	                                            <div class="css-154a57d">
	                                                <input type="password" id="newpwd" placeholder="<?php echo L('请输入新密码');?>" class="css-16fg16t" value="">
	                                                <label class="bn-input-label css-5vzups">
	                                                    <div data-bn-type="text" class="css-kiaw5d"><?php echo L('新密码');?></div>
	                                                </label>
	                                            </div>
	                                        </div>
	                                        <div style="width:100%;height:30px;"></div>
                                            <div class="css-vurnku">
	                                            <div class="css-154a57d">
	                                                <input type="password" id="renewpwd" placeholder="<?php echo L('请输入确认密码');?>" class="css-16fg16t" value="">
	                                                <label class="bn-input-label css-5vzups">
	                                                    <div data-bn-type="text" class="css-kiaw5d"><?php echo L('确认密码');?></div>
	                                                </label>
	                                            </div>
	                                        </div>
	                                        ...
	                                        <div class="css-x5jwjg">
                                                <button data-bn-type="button" id="mo_submit"  class="css-3kuzxc" style="padding: 6px 50px;"><?php echo L('提交');?></button>
                                            </div>
...
<script>
    ...
    <script type="text/javascript">
    	$("#mo_submit").click(function(){
    		...
    		$.post("<?php echo U('User/sub_respwd');?>",
