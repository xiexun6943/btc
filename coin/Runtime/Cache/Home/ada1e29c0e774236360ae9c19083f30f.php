...
<html lang="zh-CN">
    <head>
	    ...
	    <style>
	        ...
	        a:hover,a:link,a:visited,a:active{color:rgb(240, 185, 11);text-decoration:none;}
	        .allbtn {
                width: 100%;
                height: 50px;
                line-height: 50px;
	        ...
	        <div class="order_navlist" style="min-width:160px;top:50px;right: 10px;">
	            ...
	            <main class="css-1wr4jig" style="background: #fff;">
                    <div class="css-1odg5z2">
                        <div class="css-1xrgo9z"><?php echo L('新币认购');?></div>
                    </div>
                    <div class="css-uliqdc">
                        <div style="width:100%;min-height:min-600px;background:#f5f5f5;padding:20px 50px;">
                                        ...
                                        <div style="width:100%;height:240px;background:#fff;">
                                            <div style="width:100%;height:230px;">
                                                <div style="width:25%;heigth:230px;line-height:150px;text-align:center;float:left;">
                                                    <img src="/Upload/public/<?php echo ($info["imgs"]); ?>" style="width:60%;">
                                                </div>
                                                <div style="width:75%;padding:10px 0px 10px 10px;float:right;">
                                                    <div style="width:100%;min-height:30px;">
                                                        <span class="f16 fch"><?php echo ($info["name"]); ?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('认购币种');?>：<?php echo strtoupper($info['coinname']);?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('开始时间');?>：<?php echo ($info["starttime"]); ?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('结束时间');?>：<?php echo strtoupper($info['finishtime']);?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('发行总量');?>：<?php echo ($info["num"]); ?> <?php echo strtoupper($info['coinname']);?></span>
                                                    </div>
                                                    <div style="width:100%;height:30px;">
                                                        <span class="f14 fcc"><?php echo L('参与数量');?>：<?php echo ($info["ysnum"]); ?> <?php echo strtoupper($info['coinname']);?></span>
                                                    </div>
                                                </div>
                                    ...
                                    <div style="width:50%;height:240px;float:left;padding:5px;">
                                        <div style="width:100%;height:240px;">
                                            <div style="width:100%;height:240px;padding:10px 0px 10px 10px;">
                                                ...
                                                <div style="width:100%;height:30px;">
                                                    <span class="f14 fcc"><?php echo L('认购上限');?> ：<?php echo ($info["allmax"]); ?></span>
                                                </div>
                                                <div style="width:100%;height:30px;">
                                                    <span class="f14 fcc"><?php echo L('单次最低');?> ：<?php echo ($info["min"]); ?></span>
                                                </div>
                                                <div style="width:100%;height:30px;">
                                                    <span class="f14 fcc"><?php echo L('认购单价');?> ：<?php echo ($info["price"]); ?></span>
                                                </div>
                                                <div style="width:100%;min-height:30px;">
                                ...
                                <div style="width:100%;min-height:300px;margin-top:10px;padding:0px 20px;">
                                    ...
                                    <div style="width:100%;min-height:300px;border-bottom:1px solid #f5f5f5;">
                                        <div style="width:100%;height:60px;line-height:60px;">
                                            <span class="fcy f18 fw"><?php echo L('我要参与');?></span>
                                        </div>
                                        <div style="width:50%;height:50px;background:#f5f5f5;border-radius:5px;margin-bottom:10px;padding:0px 15px;margin-bottom:15px;">
				                            <div style="width:70%;height:50px;float:left;">
				                                <input type="number" oninput="tatolcoin();" id="buynum" placeholder="<?php echo L('请输入认购数量');?>" style="padding:5 15px;background:#f5f5f5;border:none;margin-top:12px;" <input type="text" name="price" placeholder="请输入价格" autocomplete="off" step="1"  min="0" onkeyup="this.value= this.value.match(/\d+(\.\d{0,2})?/) ? this.value.match(/\d+(\.\d{0,2})?/)[0] : ''" />
				                            </div>
				                        ...
				                        <div style="width:50%;height:50px;background:#f5f5f5;border-radius:5px;padding:0px 15px;">
				                            <div style="width:70%;height:50px;line-height:50px;float:left;">
				                                <span class="f14 fcc"><?php echo L('需要支付');?>：</span>
				                        ...
				                        <div style="width:100%;height:40px;border-radius:5px;padding:0px 15px;">
				                            <div style="width:70%;height:40px;line-height:40px;float:left;">
				                                <span class="f14 fcc"><?php echo L('可用'); echo strtoupper($info['buycoin']);?>：</span>
				                                <span class="f14 fcc"><?php echo ($money); ?></span>
				                            </div>
				                        </div>
				                        
				                        <input type="hidden" name="price" id="pricebox" value="<?php echo ($info["price"]); ?>" />
				                        <input type="hidden" name="min" id="minbox" value="<?php echo ($info["min"]); ?>" />
				                        <input type="hidden" name="max" id="maxbox" value="<?php echo ($info["max"]); ?>" />
				                        <input type="hidden" id="flag" value="1" />
				                        <?php if($uid <= 0): ?><div class="allbtn" onclick="gologin();" style="height:40px;line-height:50px;margin-top:5px;width:50%;    cursor: pointer;">
				                            <span class="fzmm fch"><?php echo L('请先登陆');?></span>
				                        </div>
				                        <?php else: ?>
				                        <div class="allbtn" id="sumbtn" onclick="buyissue(<?php echo ($info["id"]); ?>)" style="height:50px;line-height:50px;margin-top:5px;width:50%;    cursor: pointer;">
				                            <span class="fzmm fch"><?php echo L('立即参与');?></span>
				                        </div><?php endif; ?>
    ...
    <script type="text/javascript">
        function buyissue(id){
            ...
            if(buynum == '' || buynum == 0 || buynum == null){
                layer.msg("<?php echo L('请输入认购数量');?>");return false;
            }
            if(buynum < min){
                layer.msg("<?php echo L('不能小于最低认购量');?>");return false;
            }
            if(buynum > max){
                layer.msg("<?php echo L('不能高于最高认购量');?>");return false;
            }
            $("#flag").val(2);
            $.post("<?php echo U('Issue/upbuynum');?>",
            {'pid':pid,'num':buynum},
            function(data){
                if(data.code ==1){
                    layer.msg(data.info);
                    setTimeout(function(args){
                        window.location.href = "<?php echo U('Issue/normalissue');?>";
                    },2000);
                }else{
