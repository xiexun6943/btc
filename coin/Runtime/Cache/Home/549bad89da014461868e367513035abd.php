	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b">
	                       <a data-bn-type="link" href="<?php echo U('Finance/index');?>" class="css-z87e9z" style="text-decoration: none;">
	                       ...
	                       <a data-bn-type="link" href="<?php echo U('Finance/czlist');?>" class="css-6ijtmk"  style="text-decoration: none;">
	                           <div class="css-10j588g">
                                ...
                                <div class="css-1lu4p3l">
                                    <div class="css-b80wxf">
                                        ...
                                        <div class="css-wfexmv">
                                            <div class="css-4cffwv">
                                                <a data-bn-type="link" href="<?php echo U('User/mybill');?>" class="css-klzfmn">
                                                    <button data-bn-type="button" class=" css-z7v3zq"><?php echo L('账单');?></button>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="css-1n7u5cf">
                                                <div class="css-661iov">
                                                    <div class="css-10nf7hq">
                                                        <div data-bn-type="text" class="css-oorpkh"><?php echo L('账户总资产折合');?></div>
                                                    </div>
                                    ...
                                    <div class="css-9cxewd">
                                        <div class="css-1inwbdu">
                                            <a  class="css-9wsvyu"><?php echo L('资产列表');?></a>
                                        </div>
                                        <div class="css-1ammkwy">
                                            <div class="coinbox">
                                                <div class="cointitle">
                                                    ...
                                                    <div class="titleop" style="width:15%;">
                                                        <span class="f14 fch"><?php echo L('可用');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:15%;">
                                                        <span class="f14 fch"><?php echo L('冻结');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:15%;">
                                                        <span class="f14 fch"><?php echo L('折合');?></span>
                                                    </div>
                                                    <div class="titleop" style="width:40%;">
                                                        <span class="f14 fch"><?php echo L('操作');?></span>
                                                    </div>
                                                </div>
                                                
                                                <?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="coincontent">
                                                    <div class="contentop" style="width:15%;">
                                                        <span class="f14 fch fw"><?php echo strtoupper($vo['name']);?></span>
                                                    </div>
                                                    <div class="contentop" style="width:15%;">
                                                        <span class="f14 fch fw" id="num_<?php echo ($vo["name"]); ?>">0.000000</span>
                                                    </div>
                                                    <div class="contentop" style="width:15%;">
                                                        <span class="f14 fch fw" id="numd_<?php echo ($vo["name"]); ?>">0.000000</span>
                                                    </div>
                                                    <div class="contentop" style="width:15%;">
                                                        <span class="f14 fch fw" id="zhehe_<?php echo ($vo["name"]); ?>">0.000000</span>
                                                    </div>
                                                    <div class="contentop" style="width:40%;">
                                                        <?php  if(in_array($vo['name'],['usdt','btc','eth'])){ ?>
                                                        <a href="<?php echo U('Finance/czpage');?>?id=<?php echo ($vo["name"]); ?>" class="f14 fcy"><?php echo L('充币');?></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <a href="<?php echo U('Finance/txpage');?>?id=<?php echo ($vo["name"]); ?>" class="f14 fcy"><?php echo L('提币');?></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <?php }?>
                                                    </div>
...
<script>
    ...
    <script type="text/javascript">
        function getmoney_usdt(){
            ...
            $.post("<?php echo U('Finance/getmoneyusdt');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_btc(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneybtc');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_eth(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyeth');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_eos(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyeos');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_doge(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneydoge');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_bch(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneybch');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_ltc(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyltc');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_trx(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneytrx');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_xrp(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyxrp');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_iotx(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyiotx');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_fil(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyfil');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_shib(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyshib');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_flow(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyflow');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_jst(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyjst');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_itc(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyitc');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_ht(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyht');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_ogo(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyogo');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
        ...
        function getmoney_usdz(){
            ...
            var numdid = "#numd_" + coin;
            var zheheid = "#zhehe_" + coin;
            $.post("<?php echo U('Finance/getmoneyusdz');?>",
            {'coin':coin},
            function(data){
                if(data.code == 1){
                    $(numid).html(data.num);
    ...
    <script type="text/javascript">
        $(function(){
            ...
            getmoney_iotx();
            setInterval("getmoney_iotx()",5000);
            getmoney_fil();
            ...
            getmoney_usdt();
            setInterval("getmoney_usdt()",3000);
            getallzhehe();
    ...
    <script type="text/javascript">
        function getallzhehe(){
            $.post("<?php echo U('Finance/getallzhehe');?>",
            function(data){
                if(data.code == 1){
