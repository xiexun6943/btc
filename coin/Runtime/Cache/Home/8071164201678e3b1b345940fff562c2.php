	           ...
	           <main class="css-1wr4jig">
	               <main class="css-xry4yv">
	                   ...
	                   <div class="css-foka8b">
	                       ...
	                       <a data-bn-type="link" href="<?php echo U('User/addresslist');?>" class="css-z87e9z"  style="text-decoration: none;">
	                           <div class="css-10j588g">
	                    ...
	                    <div class="css-1wr4jig">
	                        <div class="css-1u0m1fa">
                                <div class="css-fhl5lc">
                                    <a class="css-1cdfkn6" href="##"><?php echo L('提币地址管理');?></a>
                                </div>
                            </div>
                            ...
                            <div class="css-1bbywci">
                                <div class="css-1pl31wt">
                                    <div class="css-k2y2sp">
                                        <div data-bn-type="text" class="css-1868gi1"><?php echo L('地址管理');?></div>
                                        <div class="css-x5jwjg">
                                            <button data-bn-type="button" id="addbtn" class="css-3kuzxc"><?php echo L('添加地址');?></button>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="rc-table-content" style="overflow: auto hidden;">
                                                    <table style="width: 970px; min-width: 100%; table-layout: auto;">
                                                        <thead class="rc-table-thead">
                                                            <tr>
                                                                <th class="rc-table-cell"><?php echo L('地址备注');?></th>
                                                                <th class="rc-table-cell"><?php echo L('币种');?></th>
                                                                <th class="rc-table-cell"><?php echo L('地址');?></th>
                                                                <th class="rc-table-cell"><?php echo L('转账网络');?></th>
                                                                <th class="rc-table-cell"><?php echo L('操作');?></th></th>
                                                            </tr>
                                                            
                                                        </thead>
                                                        <tbody class="rc-table-tbody">
                                                            <?php if(is_array($qblist)): foreach($qblist as $key=>$qvo): ?><tr class="rc-table-row rc-table-row-level-0">
                                                                <td class="rc-table-cell">
                                                                    <div class="css-15oyuc7">
                                                                        <div data-bn-type="text" class="css-1c82c04">
                                                                            <div data-bn-type="text" class="css-1c82c04"><?php echo ($qvo["remark"]); ?></div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="rc-table-cell">
                                                                ...
                                                                <td class="rc-table-cell">
                                                                    <div class="css-15oyuc7">
                                                                        <div class="css-1f9551p">
                                                                            <div data-bn-type="text" class="css-1c82c04"><?php echo ($qvo["addr"]); ?></div>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td class="rc-table-cell">
                                                                    <div class="css-15oyuc7">
                                                                        <div data-bn-type="text" class="css-1c82c04"><?php echo ($qvo["czline"]); ?></div>
                                                                    </div>
                                                                </td>
                                                                <td class="rc-table-cell">
                                                                    <div class="css-15oyuc7">
                                                                        <div onclick="deladdress(<?php echo ($qvo["id"]); ?>);" data-bn-type="text" class="css-1c82c04" style="color:rgb(252, 213, 53);cursor:pointer;"><?php echo L('删除');?></div>
                                                                    </div>
                                                                </td>
	    ...
	    <div class="css-1bzqcjp">
	        <div class="css-7m7e43">
	            <div class="css-13r01t2">
	                <div data-bn-type="text" class="css-ip5w0j"><?php echo L('添加提现地址');?></div>
	            ...
	            <div class="css-m0vwdv">
	                <div class="css-vurnku">
	                    <div class="css-154a57d">
	                        <input data-bn-type="input" id="remark" placeholder="<?php echo L('请输入字符的备注');?>" class="css-16fg16t" value="">
	                        <label class="bn-input-label css-5vzups">
	                            <div data-bn-type="text" class="css-kiaw5d"><?php echo L('地址备注');?></div>
	                        </label>
	                    </div>
	                </div>
	                <div class="css-3tfm4c"></div>
	                <div class="css-16vu25q" id="showcoinbtn">
	                    <div data-bn-type="text" class="css-7ng27"><?php echo L('币种');?></div>
	                    <div class="css-1im1bnu">
	                        <div data-bn-type="text" id="cointxt" class="css-1hvffwr"><?php echo L('选择币种');?></div>
	                ...
	                <div class="css-16vu25q">
	                    <div data-bn-type="text" class="css-7ng27"><?php echo L('网络');?></div>
	                    <div class="css-1im1bnu">
	                        <div data-bn-type="text" id="czlinebox" class="css-1hvffwr"><?php echo L('固定网络');?></div>
	                    </div>
	                </div>
	                <div class="css-3tfm4c"></div>
	                <div class="css-vurnku">
	                    <div class=" css-154a57d">
	                        <input data-bn-type="input" id="address" placeholder="<?php echo L('请输入提币地址');?>" class="css-16fg16t" value="">
	                        <label class="bn-input-label css-5vzups">
	                            <div data-bn-type="text" class="css-kiaw5d"><?php echo L('提币地址');?></div>
	                        </label>
	                    </div>
	                </div>
	            ...
	            <div class="css-1q9xby6">
	               <div class="css-7y16gy">
	                   <button data-bn-type="button" class=" css-1mo0ycr clockdzbox"><?php echo L('取消');?></button>
	                   <button data-bn-type="button" id="btnaddress" class=" css-p3hzj2"><?php echo L('保存');?></button>
	               </div>
    	        </div>
	        </div>
	    </div>
	            ...
	            <div class="css-1dcbbbv">
	                <div class="modaltitle css-4cffwv">
	                    <div data-bn-type="text" class="css-e6jk6i">
	                        <div data-bn-type="text" class="css-1ds83c4"><?php echo L('选择币种');?></div>
	                    </div>
	                </div>
	           ...
	           <div calss="css-1gh297f">
	               <div class="css-1ei9e9v">
	                   <div class="css-i96p0j">
	                       <?php if(is_array($coinlist)): foreach($coinlist as $key=>$vo): ?><div class="css-1qwhk23" onclick="choosecoin('<?php echo ($vo["name"]); ?>','<?php echo ($vo["czline"]); ?>',<?php echo ($vo["id"]); ?>)" style="cursor:pointer;border-bottom: 1px solid #f5f5f5;">
	                           <div class="css-hwqc42">
	                               <div class="css-1c0gi8w">
	                                   <div class="css-n2vpdm">
	                                       <div class="css-vurnku">
	                                           <span data-bn-type="text" class="css-1c82c04"><?php echo ($vo["title"]); ?></span>
	                                       </div>
	                                       <div data-bn-type="text" title="1inch" class="css-yo3oki"><?php echo ($vo["name"]); ?></div>
	                                   </div>
	                               </div>
	                            </div>
    ...
    <script type="text/javascript">
        ...
        function choosecoin(coin,czline,id){
            ...
            if(coinname == '' || coinname == null){
                layer.msg("<?php echo L('选择币种');?>");return false;
            }
