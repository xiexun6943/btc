	        ...
	        <div class="order_navlist" style="min-width:160px;top:50px;right: 10px;">
	            ...
	            <main class="css-1wr4jig" style="background: #fff;">
	                <div class="css-pnjgxq">
	                    <div data-bn-type="text" class="css-163lzuo"><?php echo L('请输入您的问题');?></div>
	                    <div class=" css-8pdsjp">
	                        <input  value="" placeholder="<?php echo L('在这儿搜索');?>" maxlength="50" class="css-16fg16t">
	                ...
	                <div class="css-wp2li4">
	                    <div class="mirror-bread-crumb css-19zx9ks">
	                        <a data-bn-type="link"  class="css-o4bcl2"><?php echo L('帮助中心');?></a>
	                    </div>
	                    <div class="css-wl17qh">
	                        <div class="css-1s5qj1n">
	                            <h1 data-bn-type="text" class="css-101kg5g"><?php echo L('公告中心');?></h1>
	                            <div class="css-vurnku">
	                                <div class="css-wmvdm0"></div>
	                                <div class="css-6f91y1">
	                                    <div class="css-ktxhrn">
	                                        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><a href="<?php echo U('Index/gginfo');?>?id=<?php echo ($vo["id"]); ?>" class="css-qinc3w" style="cursor: pointer;"><?php echo ($vo["title"]); ?> </a><?php endforeach; endif; ?>
	                                    </div>
	                                </div>
	                            </div>
	                        </div>
