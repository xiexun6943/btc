...
<html lang="zh-CN">
  ...
  <body>
	<div class="container-fluid"  style="padding:0px;width:100vw;height:100vh;">
		<div class="no_header"  style="position: fixed;z-index: 9999;background: #fff;padding:0px 10px;top:0px;">
			<div class="fl bhalf allhg txtl" style="line-height:50px;">
				<i class="bi bi-arrow-left fcc fw" onclick="goindex()" style="font-size: 26px;"></i>
			</div>
			<a href="<?php echo U('user/online');?>">
			<div class="fr bhalf allhg txtr" style="line-height:50px;">
				<i class="bi bi-headset fcc fw"   style="font-size: 26px;"></i>
			</div>
			</a>
		</div>

		<div class="no_content" style="width:95%;margin:60px auto;">
			...
			<div class="no_inbox">
				<a href="<?php echo U('Login/setlang');?>">
					<div class="lbox">
						<div class="lbox_l">
							...
							<span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('语言');?></span>
						</div>
						<div class="lbox_r">
							<?php if(LANG_SET=='zh-cn'){?>
							<span class="fcc fzmmm" style="font-size:16px;">中文简体&nbsp;&nbsp;</span>
							<?php }elseif(LANG_SET=='en-us'){?>
							<span class="fcc fzmmm" style="font-size:16px;">English&nbsp;&nbsp;</span>
							<?php }elseif(LANG_SET=='fr-fr'){?>
							<span class="fcc fzmmm" style="font-size:16px;">Français&nbsp;&nbsp;</span>
							<?php }elseif(LANG_SET=='de-de'){?>
							<span class="fcc fzmmm" style="font-size:16px;">Deutsch&nbsp;&nbsp;</span>
							<?php }elseif(LANG_SET=='it-it'){?>
							<span class="fcc fzmmm" style="font-size:16px;">Italiano&nbsp;&nbsp;</span>
							<?php }elseif(LANG_SET=='ja-jp'){?>
							<span class="fcc fzmmm" style="font-size:16px;">日本語&nbsp;&nbsp;</span>
							<?php }?>
				...
				<a href="<?php echo U('User/authrz');?>">
					<div class="lbox">
						<div class="lbox_l">
							...
							<span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('实名认证');?></span>
						</div>
						<div class="lbox_r">
							<i class="bi bi-chevron-right fcc fw" style="font-size: 22px;"></i>
						</div>
				...
				<a href="<?php echo U('User/addresslist');?>">
					<div class="lbox">
						<div class="lbox_l">
							...
							<span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('提币地址');?></span>
						</div>
						<div class="lbox_r">
							<i class="bi bi-chevron-right fcc fw" style="font-size: 22px;"></i>
						</div>
				...
				<a href="<?php echo U('Index/spwd');?>">
					<div class="lbox">
						<div class="lbox_l">
							...
							<span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('修改密码');?></span>
						</div>
						<div class="lbox_r">
							<i class="bi bi-chevron-right fcc fw" style="font-size: 22px;"></i>
						</div>
				...
				<a href="<?php echo U('User/appeal');?>">
					<div class="lbox">
						<div class="lbox_l">
							<i class="bi bi-screwdriver fcc fzmmm" style="font-size:22px;"></i>
							<span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('上诉');?></span>
						</div>
						<div class="lbox_r">
							<i class="bi bi-chevron-right fcc fw" style="font-size: 22px;"></i>
						</div>
				...
				<a href="<?php echo U('Login/lhelp');?>">
					<div class="lbox">
						<div class="lbox_l">
							...
							<span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('帮助中心');?></span>
						</div>
						<div class="lbox_r">
							<i class="bi bi-chevron-right fcc fw" style="font-size: 22px;"></i>
						</div>
				...
				<a href="<?php echo U('Index/notice');?>">
					<div class="lbox">
						<div class="lbox_l">
							...
							<span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('通知');?></span>
						</div>
						<div class="lbox_r">
							<?php if($count >= 1): ?><span class="fzmm fcy"><?php echo L('新通知');?></span><?php endif; ?>
							<i class="bi bi-chevron-right fcc fw" style="font-size: 22px;"></i>
						</div>
					</div>
				</a>
				...
				<a href="<?php echo U('Index/tgcode');?>">
					<div class="lbox">
						<div class="lbox_l">
							...
							<span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('我的邀请码');?></span>
						</div>
							<div class="lbox_r">
								<i class="bi bi-chevron-right fcc fw" style="font-size: 22px;"></i>
							</div>
				...
				<div class="lbox">
					<div class="lbox_l">
						...
						<span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('关于我们');?></span>
					</div>
				...
				<div class="lbox">
					<div class="lbox_l">
						...
						<span class="fcc fzmmm" style="font-size:18px;">&nbsp;&nbsp;<?php echo L('MSB认证');?></span>
					</div>
