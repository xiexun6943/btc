	...
	<div class="container-fluid " style="padding:0px;width:100vw;">
		...
		<div class="contentbox">
		    <div class="contentbox_top">
		        <span style="font-size:26px;font-weight:500;"><?php echo L('提币');?></span>
		    </div>
		    ...
		    <div class="imgbox">
		        <div class="imgbox_1">
		            <span class="fzmmm fch"><?php echo L('提币网络');?></span>
		        </div>
		        <div class="imgbox_2">
		            <div class="imgbox_3">
		                <span class="fzmm fcy" id="czline"><?php echo ($info["czline"]); ?></span>
		            </div>
		        </div>
		        
		        <div class="imgbox_1" style="margin-top:10px;">
		            <span class="fzmmm fch"><?php echo L('提币地址');?></span>
		        </div>
		        
		        <div class="tx_inputbox">
		            <div class="tx_inputbox_l">
		                <input type="text" id="address" name="address" placeholder="<?php echo L('输入或长按粘贴地址');?>" style="background:#f5f5f5;border:1px solid #f5f5f5;width: 100%;height:30px;" />
		            </div>
		        ...
		        <div class="imgbox_1" style="margin-top:10px;">
		            <div style="width:30%;height:40px;line-height:40px;float:left;">
		                <span class="fzmmm fch"><?php echo L('提币数量');?></span>
		            </div>
		        ...
		        <div class="tx_inputbox">
		            <div class="tx_inputbox_l" style="width:65%;">
		                <input type="text" id="tbnum" onblur="changenum();" name="tbnum" placeholder="<?php echo L('输入提币数量');?>" style="background:#f5f5f5;border:1px solid #f5f5f5;height: 30px;" autocomplete="off" step="1"  min="0" onkeyup="this.value= this.value.match(/\d+(\.\d{0,2})?/) ? this.value.match(/\d+(\.\d{0,2})?/)[0] : ''" />
		            </div>
				...
				<div class="imgbox_1" style="margin-top:10px;">
					<span class="fzmmm fch"><?php echo L('提现密码');?></span>
				</div>

				<div class="tx_inputbox">
					<div class="tx_inputbox_l">
						<input type="text" id="paypwd" name="paypwd" placeholder="<?php echo L('提现密码');?>" style="background:#f5f5f5;border:1px solid #f5f5f5;width: 100%;height:30px;" />
					</div>
				</div>
		        ...
		        <div class="imgbox_1">
		            <div style="width:50%;height:40px;line-height:40px;float:left;">
		                <span class="fzm fcc"><?php echo L('手续费');?></span>
		            </div>
		            <div style="width:50%;height:40px;line-height:40px;float:right;text-align:right;">
		                <span class="fzm fcc"><?php echo ($info["txsxf"]); ?>%</span>
		    ...
		    <div class="textbox">
		        ...
		        <p class="fzm fch"><?php echo L('为保障资金安全，当您账户安全策略变更，密码修改，我们会对提币进行人工审核，请耐心等待工作人员电话或邮件联系.');?></p>
    ...
    <div class="addressinfo">
        <div class="addressinfo_1">
            <div class="addressinfo_2">
                <span class="fzmmm fch"><?php echo L('选择'); echo strtoupper($info['name']); echo L('地址');?></span>
            </div>
        ...
        <div class="addressinfo_4">
            <span class="fzm fcy"><?php echo L('地址管理');?></span>
        ...
        <div class="addressinfo_5" id="tbadressbtn">
            <div class="overflow">
				...
				<span class="fzmm fch" id="address_remark"><?php echo ($adrinfo["name"]); ?>-<?php echo ($adrinfo["czline"]); ?></span>
            </div>
            <div class="overflow">
                <i class="bi bi-link-45deg fch fzmmm"></i>
                <span class="fzmm fch" id="address_addr"><?php echo ($adrinfo["addr"]); ?></span>
            </div>
        </div>
...
<script type="text/javascript">
    $("#sumbtn").click(function(){
        ...
        {'address':address,'num':num,'id':id,'paypwd':paypwd},
        function(data){
            if(data.code == 1){
                layer.msg(data.info);
                setTimeout(function(){
