...
<div id="main-content">
    ...
    <div id="main" class="main">
        ...
        <div class="cf">
            <div class="fl">
                <a class="btn btn-success" href="<?php echo U('Config/ctmarketEdit');?>">新 增</a>
                <button class="btn ajax-post btn-info" url="<?php echo U('Config/ctmarketoStatus',array('type'=>'resume'));?>" target-form="ids">启 用
                </button>
                <button class="btn ajax-post btn-warning" url="<?php echo U('Config/ctmarketoStatus',array('type'=>'forbid'));?>" target-form="ids">禁 用
                </button>
                <button class="btn ajax-post confirm btn-danger" url="<?php echo U('Config/ctmarketoStatus',array('type'=>'del'));?>" target-form="ids">删 除
                </button>
            </div>
        </div>
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if(($vo["state"]) == "1"): ?><b style="color: #028E16;">正常</b>
                                <?php else: ?>
                                    <b style="color: #F70408">禁止</b><?php endif; ?>
                            </td>

                            <td style="text-align: center;">
								<a href="<?php echo U('Config/ctmarketEdit?id='.$vo['id']);?>" class="btn btn-primary btn-xs">编辑</a>
                            </td>
...
<div style="display:none;">
    ...
    <script type="text/javascript" charset="utf-8">
        //导航高亮
        highlight_subnav("<?php echo U('Config/ctmarket');?>");
    </script>