...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			...
			<div class="fr">
			    <button class="btn btn-warning" onClick="location.href='<?php echo U('User/coin');?>'">初始化搜索</button>
			</div>
		</div>
		<div class="cf">
...
<!--					<th class="">ID</th>-->
					<th class="">用户id</th>
					<th class="">用户名</th>
					<?php if(is_array($coinlist)): $i = 0; $__LIST__ = $coinlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><th class=""><?php echo ($v['name']); ?>(<?php echo strtoupper($v['name']);?>)</th><?php endforeach; endif; else: echo "" ;endif; ?>
				</tr>
				</thead>
				<tbody>
...
<!--							<td><?php echo ($vo["id"]); ?></td>-->
							...
							<?php if(is_array($coinlist)): $i = 0; $__LIST__ = $coinlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><td><?php echo ($v['name']); ?><br>
