...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('User/log');?>">登陆日志</a> >></span>
			 <span class="h1-title"><?php if(empty($data)): ?>添加日志
				 <?php else: ?>
			                                           编辑日志<?php endif; ?></span>
		</div>
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('User/logEdit');?>" method="post" class="form-horizontal">
						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="type" value="<?php echo ($data["type"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="addip" value="<?php echo ($data["addip"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
...
<div style="display:none;">
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('User/log');?>");
	</script>