...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			...
			<div class="fr">
				<button class="btn btn-warning" onClick="location.href='<?php echo U('User/noticelist');?>'">初始化搜索</button>
			</div>
		</div>
		<div>
			<div class="cf">
			    <div class="fl">
				<button class="btn ajax-post confirm btn-danger " url="<?php echo U('User/noticedel',array('type'=>'1'));?>" target-form="ids">删 除</button>
			    </div>
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>    
                                <?php if($vo["status"] == 1): ?><span style="color:red;">未读</span>
...
<div style="display:none;">
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('User/noticelist');?>");
	</script>