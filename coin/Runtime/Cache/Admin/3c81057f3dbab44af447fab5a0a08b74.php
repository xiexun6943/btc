...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			...
			<span class="h2-title">>><a href="<?php echo U('Kuangm/kjlist');?>">运行中的矿机</a></span>
		</div>
		<div class="cf">
			<div class="fl">
				<button class="btn ajax-post btn-info " url="<?php echo U('Kuangm/userkjStatus',array('type'=>'1','mobile'=>'Admin'));?>" target-form="ids">启动收益</button>
				<button class="btn ajax-post btn-warning " url="<?php echo U('Kuangm/userkjStatus',array('type'=>'2','mobile'=>'Admin'));?>" target-form="ids">禁止收益</button>
				<button class="btn ajax-post confirm btn-danger " confirm-msg="批量删除不可恢复,确定删除?" url="<?php echo U('Kuangm/userkjStatus',array('type'=>'3','mobile'=>'Admin'));?>" target-form="ids">删除矿机</button>
			</div>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
							    ...
							    <?php elseif($vo["type"] == 2): ?>
							        <span>共享</span>
							        <br />
							        <?php echo ($vo["sharebl"]); ?>%<?php endif; ?>
							</td>
							<td><?php echo ($vo["kjtitle"]); ?></td>
							...
							<td>
							    ...
							    <?php elseif($vo["status"] == 2): ?>
							        <span style="color:red;">停止</span><?php endif; ?>
							</td>
...
<div style="display:none;">
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('Kuangm/kjlist');?>");
	</script>