	...
	<div id="main" class="main">
		...
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('User/recharge');?>" method="post" class="form-horizontal">
						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									...
									<td>
										<input type="text"  style="color:red" class="form-control input-10x" name="username" value="<?php echo ($data["username"]); ?>" readonly='ture' >
									</td>
								...
								<tr class="controls">
									<td class="item-label">数 目 :</td>
									<td>
										<input type="text" class="form-control input-8x" name="num" value="">
									</td>
									<td class="item-note"></td>
								</tr>
