...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			...
			<span class="h2-title">>><a href="<?php echo U('Kuangm/djprofit');?>">收益列表</a></span>
		</div>
		<div class="cf">
		...
		<div class="data-table table-striped">
			<table class="">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
							...
							<td>
							    <?php if($vo["status"] == 1): ?><span style="color:green">待释放</span>
							    <?php elseif($vo["status"] == 2): ?>
							    <span style="color:red">已释放</span><?php endif; ?>
							</td>
							<td><?php echo ($vo["addday"]); ?></td>
							<td><?php echo ($vo["thawday"]); ?></td>
...
<div style="display:none;">
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('Kuangm/djprofit');?>");
	</script>