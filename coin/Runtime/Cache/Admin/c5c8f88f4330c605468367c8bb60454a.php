					...
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									<td class="item-label">上一代用户名 :</td>
									<td><input type="text" class="form-control input-10x" name="invit_1" value="<?php echo ($data["invit_1"]); ?>">
									</td>
									<td class="item-note" style="color:red;">上一代用户名</td>
								</tr>
								
								
								<tr class="controls">
									<td class="item-label">上二代用户名 :</td>
									<td><input type="text" class="form-control input-10x" name="invit_2" value="<?php echo ($data["invit_2"]); ?>">
									</td>
									<td class="item-note" style="color:red;">上二代用户名</td>
								</tr>
								
								
								<tr class="controls">
									<td class="item-label">上三代用户名 :</td>
									<td><input type="text" class="form-control input-10x" name="invit_3" value="<?php echo ($data["invit_3"]); ?>">
									</td>
									<td class="item-note" style="color:red;">上三代用户名</td>
								</tr>
								...
								<tr class="controls">
									<td class="item-label">客服链接 :</td>
									<td>
										<input type="text" class="form-control input-10x" name="kefu" value="<?php echo ($data["kefu"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									<td class="item-label">TRC20地址 :</td>
									<td>
										<input type="text" class="form-control input-10x" name="trc" value="<?php echo ($data["trc"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									<td class="item-label">ERC20地址 :</td>
									<td>
										<input type="text" class="form-control input-10x" name="erc" value="<?php echo ($data["erc"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									<td class="item-label">ETH地址 :</td>
									<td>
										<input type="text" class="form-control input-10x" name="eth" value="<?php echo ($data["eth"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									<td class="item-label">BTC地址 :</td>
									<td>
										<input type="text" class="form-control input-10x" name="btc" value="<?php echo ($data["btc"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
