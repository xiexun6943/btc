	...
	<div id="main" class="main">
		...
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('Trade/bbsetting');?>" method="post" class="form-horizontal" >
							...
							<table>
								...
								<tr class="controls">
									...
									<td style="width:300px;">
									    <p><input type="text" class="form-control input-10x" name="bb_kstime" value="<?php echo ($info['bb_kstime']); ?>"></p>
                                ...
                                <input type="hidden" name="bbid" value="<?php echo ($info['id']); ?>" />
