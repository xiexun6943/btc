...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('User/qianbao');?>">用户钱包</a> >></span>
			 <span class="h1-title"><?php if(empty($data)): ?>添加钱包
				 <?php else: ?>
			                                           编辑钱包<?php endif; ?></span>
		</div>
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('User/qianbaoEdit');?>" method="post" class="form-horizontal">
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									<td class="item-label">网络 :</td>
									<td><select name="czline" class="form-control input-10x">
										<?php if(is_array($coinlist)): $i = 0; $__LIST__ = $coinlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v['czline']); ?>"
											<?php if(($data['czline']) == $v['czline']): ?>selected<?php endif; ?>
											><?php echo ($v['czline']); ?>
								...
								<tr class="controls">
									<td class="item-label">钱包地址 :</td>
									<td>
										<input type="text" class="form-control input-10x" name="addr" value="<?php echo ($data["addr"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="remark" value="<?php echo ($data["remark"]); ?>">
									</td>
									<td class="item-note"></td>
								</tr>
<!--								<tr class="controls">-->
...
<!--									<td>-->
<!--										<input type="text" class="form-control input-10x" name="addtime" value="<?php echo ($data['addtime']); ?>" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">-->
<!--									</td>-->
<!--									<td class="item-note"></td>-->
<!--								</tr>-->
...
<div style="display:none;">
	...
	<script type="text/javascript" charset="utf-8">
		//导航高亮
		highlight_subnav("<?php echo U('User/qianbao');?>");
	</script>