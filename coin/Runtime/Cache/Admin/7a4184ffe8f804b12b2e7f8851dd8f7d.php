...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('Article/index');?>">公告中心</a></span>
		</div>
		<div class="cf">
			<div class="fl">
				<a class="btn btn-success " href="<?php echo U('Article/edit');?>">新 增</a>
				<button class="btn ajax-post confirm btn-danger " url="<?php echo U('Article/setstatus',array('type'=>'1'));?>" target-form="ids">删 除</button>
			</div>
		</div>
