...
<div id="main-content">
	...
	<div id="main" class="main">
		<div class="main-title-h">
			<span class="h1-title"><a href="<?php echo U('User/admin');?>">管理员管理</a> &gt;&gt;</span>
             <span class="h1-title"><?php if(empty($data)): ?>添加管理员<?php else: ?>编辑管理员<?php endif; ?></span>
		</div>
		<div class="tab-wrap">
			<div class="tab-content">
				<form id="form" action="<?php echo U('User/adminEdit');?>" method="post" class="form-horizontal">
						...
						<div class="form-item cf">
							<table>
								...
								<tr class="controls">
									...
									<td>
										<input type="text" class="form-control input-10x" name="nickname" value="<?php echo ($data["nickname"]); ?>">
									</td>
								...
								<tr class="controls">
									...
									<td><input type="text" class="form-control input-10x" name="moble" value="<?php echo ($data["moble"]); ?>"></td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									<td class="item-label">邮箱 :</td>
									<td><input type="text" class="form-control input-10x" name="email" value="<?php echo ($data["email"]); ?>"></td>
									<td class="item-note"></td>
								</tr>
								<tr class="controls">
									<td class="item-label">角色 :</td>
									<td>
										<select name="role" class="form-control input-10x">
											<option value="1" <?php if(($data["role"]) == "1"): ?>selected<?php endif; ?>>管理员</option>
											<option value="2" <?php if(($data["role"]) == "2"): ?>selected<?php endif; ?>>客服</option>
										</select>
									</td>
									<td class="item-note"></td>
								</tr>
