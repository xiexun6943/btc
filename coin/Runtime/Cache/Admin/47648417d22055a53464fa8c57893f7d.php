				...
				<form id="form" action="<?php echo U('Config/qitaEdit');?>" method="post" class="form-horizontal" >
					<div id="tab" class="tab-pane in tab">
						<div class="form-item cf">
							<table>
							    <tr class="controls">
									<td class="item-label">客服地址 :</td>
									<td><input type="text" class="form-control input-10x" name="kefu" value="<?php echo ($data['kefu']); ?>"></td>
									<td class="item-note" style="color:red;">*客服地址</td>
								</tr>
								
								 <tr class="controls">
									<td class="item-label">上诉页地址 :</td>
									<td><input type="text" class="form-control input-10x" name="appeal" value="<?php echo ($data['appeal']); ?>"></td>
									<td class="item-note" style="color:red;">*上诉页地址</td>
								</tr>
