...
<div id="main-content">
    ...
    <div id="main" class="main">
        ...
        <div class="cf">
            <div class="fl">
                <a class="btn btn-success" href="<?php echo U('Config/marketoEdit');?>">新 增</a>
                <button class="btn ajax-post btn-info" url="<?php echo U('Config/marketoStatus',array('type'=>'resume'));?>" target-form="ids">启 用
                </button>
                <button class="btn ajax-post btn-warning" url="<?php echo U('Config/marketoStatus',array('type'=>'forbid'));?>" target-form="ids">禁 用
                </button>
                <button class="btn ajax-post confirm btn-danger" url="<?php echo U('Config/marketoStatus',array('type'=>'del'));?>" target-form="ids">删 除
                </button>
            </div>
                ...
                <div class="sleft">
                    <form name="formSearch" id="formSearch" method="get" name="form1" >
                        <select style=" width: 160px; float: left; margin-right: 10px;" name="field" class="form-control">
                            <option value="name" <?php if(($_GET['field']) == "name"): ?>selected<?php endif; ?>>市场名</option>
                        </select>
        ...
        <div class="data-table table-striped">
            <table class="">
                ...
                <?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if(($vo["shuadan"]) == "1"): ?><b style="color: #028E16;">已开启</b><?php else: ?><b style="color: #F70408">未启动</b><?php endif; ?>
                            </td>
                            <td>
                                <?php if(($vo["trade"]) == "1"): ?><b style="color: #028E16;">开启交易</b><?php else: ?><b style="color: #F70408">禁止交易</b><?php endif; ?>
                            </td>
                            <td>
                                <?php if(($vo["status"]) == "1"): ?><b style="color: #028E16;">可用</b><?php else: ?><b style="color: #F70408">禁用</b><?php endif; ?>
                            </td>

                            <td style="text-align: center;">
								<a href="<?php echo U('Config/marketoEdit?id='.$vo['id']);?>" class="btn btn-primary btn-xs">编辑</a>
								<a href="<?php echo U('Config/marketoEdit2?id='.$vo['id']);?>" class="btn btn-primary btn-xs">行情</a>
								<a href="<?php echo U('Config/marketoEdit3?id='.$vo['id']);?>" class="btn btn-primary btn-xs">机器人</a>
                            </td>
